            ...
            <div className="forgot-pwd-page-wrapper">
                {this.state.hideThankYou ? (<section className="right-section forgot-pwd-section pull-right">
                    ...
                    <div className="form-wrapper">
                        ...
                        <p className="mb-30">Please provide your registered email address to aid in the password
                            recovery process.</p>
                    ...
                    <section className="right-section reset-link-section pull-right">
                        ...
                        <div className="form-wrapper">
                            ...
                            <h5>An email has been sent to <b>{this.state.email}</b>. Please click on the link provided
                                in the mail to reset your password.</h5>
                            <p>In case you do not receive your password reset email shortly, please check your spam
                                folder.</p>
                            <div className="btns">
                                <button type="submit" onClick={() => utils.changeUrl(routesPath['SIGN_IN'])}
