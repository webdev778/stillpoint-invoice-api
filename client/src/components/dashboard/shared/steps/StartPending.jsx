            ...
            if (err) {
                ...
                if (utils.isResSuccess(response)) {
                    ...
                    for (let fedTaxClassificationsObj of that.federalTaxValueArr) {
                        fedTaxClassifications.push(<option key={fedTaxClassificationsObj['_id']}
                                                           value={fedTaxClassificationsObj['_id']}>{fedTaxClassificationsObj['name']}</option>);
                    }
                ...
                {this.isSeekerProfile() ?
                    highestStep === (constant['JOB_STEPS']['S_PENDING'] * -1) ?
                        ...
                        (
                            ...
                            Legably uses Stripe Connect to handle milestone payments between job posters and job seekers (see our <a
                                href={routesPath['FAQ']} target="_blank">FAQ</a> for details). In order to do this you will need to create a Stripe account by clicking on the Create Stripe Account button below. This will send you to the Stripe site where you will create your account, complete your profile, and setup your payment preferences.
                            </span>
                            <span className="d-block">
                            After you complete these actions you will be returned to the Legably site. Your Stripe account information will be securely linked with your Legably account and kept private (see our <a
                                href={routesPath['PRIVACY_POLICY']} target="_blank">Privacy Policy</a> for details). If you have any additional questions about Legably's relationship with Stripe that our FAQ or Privacy Policy doesn't answer please contact the Legably support team at <a
                                href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a>.
                            </span>
                          </span>
                                            </p>
                                            <button type="button" className={primaryBtnClass}
                                                    onClick={this.createStripeAccount.bind(this, jobId, constant['ROLE']['SEEKER'])}>
                                ...
                                }
                                {
                                    this.state.isEditableMode ?
                                        <form id="editable_form" className="editable-form">
                                            ...
                                            <div
                                                className={formErrors.legalName ? 'form-group global-error' : 'form-group'}>
                                            ...
                                            <div
                                                className={formErrors.address ? 'form-group global-error' : 'form-group'}>
                                            ...
                                            <div className="row">
                                                <div
                                                    className={formErrors.city ? 'form-group col-sm-4 global-error' : 'form-group col-sm-4'}>
                                                ...
                                                <div
                                                    className={formErrors.state ? 'form-group col-sm-4 global-error' : 'form-group col-sm-4'}>
                                                    <label htmlFor="state">State*</label>
                                                    <select className="form-control" name="state"
                                                            value={formValObj.state} onBlur={this.handleBlur}
                                                            onChange={this.handleChange}>
                                                ...
                                                <div
                                                    className={formErrors.zipCode ? 'form-group col-sm-4 global-error' : 'form-group col-sm-4'}>
                                                    <label htmlFor="zip_code">Zip Code*</label>
                                                    <input type="text" className="form-control" name="zipCode"
                                                           placeholder="Zip Code" autoComplete="zip_code"
                                            ...
                                            <div
                                                className={formErrors.taxpayerIdNumber ? 'form-group group-radio global-error' : 'form-group group-radio'}>
                                                <label htmlFor="TIN">
                                                ...
                                                <div className="radio-btns mb-5">
                                                    <ul className="list radio-list m-0 p-0">
                                                        <li className="list__item">
                                                            <input id="ssn" type="radio" className="radio-btn"
                                                                   name="taxpayerIdNumber" value='SSN'
                                                                   checked={this.isTaxpayerTypeSSN()}
                                                                   onChange={(e) => this.onRadioBtnChange(e)}/>
                                                            <label htmlFor="ssn" className="label p-0">Social Security
                                                                Number (SSN)</label>
                                                        </li>
                                                        <li className="list__item m-10 ml-0">
                                                            <input id="ein" type="radio" className="radio-btn"
                                                                   name="taxpayerIdNumber" value="EIN"
                                                                   checked={!this.isTaxpayerTypeSSN()}
                                                                   onChange={(e) => this.onRadioBtnChange(e)}/>
                                                            <label htmlFor="ein" className="label p-0">Employer
                                                                Identification Number (EIN)</label>
                                                        </li>
                                                    </ul>
                                                </div>
                                                <Mask dataValue={formValObj.taxpayerIdNumber} isReverse={false}
                                                      mask={this.isTaxpayerTypeSSN() ? "000-00-0000" : "00-0000000"}
                                                      nameValue="taxpayerIdNumber"
                                                      placeholderValue={this.isTaxpayerTypeSSN() ? "xxx-xx-xxxx" : "xx-xxxxxxx"}
                                                      onMaskBlur={this.handleBlur} onMaskChange={this.handleChange}/>
                                            ...
                                            <div
                                                className={formErrors.federalTax ? 'form-group global-error' : 'form-group'}>
                                                <label htmlFor="sel_tax">Federal tax classification*</label>
                                                <select className="form-control sel-tax" id="sel_tax" name="federalTax"
                                                        value={formValObj.federalTax} onBlur={this.handleBlur}
                                                        onChange={this.handleFederalTaxChange}>
                                            ...
                                            {this.state.showFederalTaxOther ?
                                                <div
                                                    className={formErrors.federalTaxOther ? 'form-group global-error mt-minus-10' : 'form-group mt-minus-10'}>
                                                    <input type="text" className="form-control" name="federalTaxOther"
                                                           placeholder="" autoComplete="federal_tax_other"
                                            ...
                                            <div
                                                className={this.state.termsChecked === false ? 'i-certify not-certified' : 'i-certify'}>
                                                ...
                                                <div className="pl-30">
                                                    ...
                                                    <p>
                                                        ...
                                                        no longer subject to withholding; and
                                                    </p>
                                                    <p>
                                                        3. I am a U.S. citizen or other U.S. person.
                                                    </p>
                                                    <p>
                                                        <b>Note:</b> Only check this certification if all of these items
                                                        are true, otherwise contact <a
                                                        href={routesPath['SUPPORT_CENTER']} target="_blank">Customer
                                                        Support</a>.
                                                    </p>
                                                </div>
                                            </div>
                                            <div className="d-flex flex-row-reverse mb-15">
                                                <div className="btns">
                                                    <button type="button" className="btn btn-grey"
                                                            onClick={this.onCancelBtnClick}>Cancel
                                                    </button>
                                                    <button type="button" className="btn btn-primary mb-0"
                                                            onClick={() => this.saveWNineInfo()}>Save
                                                    </button>
                                                </div>
                                            </div>
                                        </form>
                                        ...
                                        <form id="filled_form" className="info-form form-horizontal mt-25">
                                            <div className="d-flex justify-content-between mb-15">
                                                ...
                                                <div className="btns">
                                                    <button type="button" className="btn btn-primary"
                                                            onClick={() => this.onEditBtnClick()}>Edit
                                                    </button>
                                                </div>
                                            </div>
                                            <div className="form-group row mb-15">
                                                <label htmlFor="leg-name" className="control-label col-sm-3 col-md-2">Legal
                                                    Name</label>
                                            ...
                                            <div className="form-group row mb-15">
                                                <label htmlFor="address"
                                                       className="control-label col-sm-3 col-md-2">Address</label>
                                                <div className="col-sm-9 col-md-10">
                                                    <p>{formValObj.address}, {formValObj.city}, {this.state.stateName}, {formValObj.zipCode}</p>
                                                </div>
                                            </div>
                                            <div className="form-group row mb-15">
                                                <label htmlFor="tin" className="control-label col-sm-3 col-md-2">Taxpayer
                                            ...
                                            <div className="form-group row mb-0">
                                                <label htmlFor="ftc" className="control-label col-sm-3 col-md-2">Federal
                                ...
                                <div className="preference-msg-btns">
                                    {
                                        highestStep === constant['JOB_STEPS']['J_COMPLETE'] ?
                                            null
                                            :
                                            <button type="button" className="btn btn-primary m-0 ml-auto"
                                    ...
                                    highestStep > constant['JOB_STEPS']['S_PENDING'] ?
                                        ...
                                        <div className="status-content proposed-terms-footer">
                                            ...
                                            <div className="btn p-0 m-0">
                                                <button type="button" className={withdrawBtn}
                                                        onClick={this.onWithdrawBtnClick.bind(this, jobId, (constant['JOB_STEPS']['S_PENDING'] * -1), null, constant['ROLE']['SEEKER'])}>Withdraw
                                                    From Consideration
                                                </button>
                                            </div>
                                            <p className="d-inline-block m-0">To remove yourself from consideration for
                                                this job click the Withdraw From Consideration button.</p>
                                        </div>
                                }
                            </div>
                        )
                    ...
                    <div className="status-content mt-45">
                        ...
                        After you complete these actions you will be returned to the Legably site. Your Stripe account information will be securely linked with your Legably account and kept private (see our <a
                            ...
                            href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a>.
                                ...
                                <button type="button" className={primaryBtnClass}
                                        onClick={this.createStripeAccount.bind(this, jobId, constant['ROLE']['POSTER'])}>
                                    Create Stripe Account
                                </button>
                            </div>
                            :
                        ...
                        (
                            isFundsNotTransfer ?
                                <div>
                                    ...
                                    <button type="button" className={yellowBtnClass}
                                            disabled={stepRelatedData.stripe_account_status !== constant['STRIPE_ACCOUNT_STATUS']['ACTIVATED']}
                                            onClick={this.transferFunds.bind(this, jobId)}>
                                        Transfer Funds
                                    </button>
                                </div>
                                :
                                <p className="d-flex">
                                    <i className="fa fa-check-circle"></i>
                                    <span
                                        className="pl-10">The transfer of ${this.getFormattedAmount(stepRelatedData.amount)} to Legably has been started. Once the transfer is complete (it can take up to two days) the job status will be changed to In Progress and your candidate will be notified so they can begin work.</span>
                                </p>
                        )
                        }
                        <div className="preference-msg-btns pl-25">
                            {
                                highestStep === constant['JOB_STEPS']['J_COMPLETE'] ?
                                    ...
                                    :
                                    <button type="button" className="btn btn-primary"
                                            onClick={this.onSendMsgBtnClick.bind(this, stepRelatedData.seekerId)}>
                                        Send Message
                                    </button>
                            }
                        </div>
                        {
                            highestStep > constant['JOB_STEPS']['S_PENDING'] ?
                                ...
                                <div className="status-content proposed-terms-footer">
                                    ...
                                    <div className="btn p-0 m-0">
                                        <button type="button" className={withdrawBtn}
                                                onClick={this.onWithdrawBtnClick.bind(this, jobId, (constant['JOB_STEPS']['S_PENDING'] * -1), stepRelatedData.seekerId, constant['ROLE']['POSTER'])}>Withdraw
                                            From Consideration
                                        </button>
                                    </div>
                                    <p className="d-inline-block m-0">To remove this candidate from consideration for
                                        this job click the Withdraw From Consideration button.</p>
                                </div>
                        }
                    </div>
