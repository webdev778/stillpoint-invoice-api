    ...
    render() {
        ...
        return (
            <Role step="experience" role="seeker" profileStatus={this.state.completeStatus}>
                <div className="visible-xs mobile-page-heading"><span className="previous"
                                                                      onClick={() => utils.changeUrl(routesPath['SEEKER_BASIC_INFO'])}></span> Experience <span
                    onClick={() => utils.changeUrl(routesPath['SEEKER_HEADLINE'])}
                    className={this.state.completeStatus >= 2 ? 'next' : 'next disabled-element'}></span></div>
                <form onSubmit={this.handleExpSubmit}>
                    <div className="form experience-form">
                                ...
                                return <div key={index}>
                                    <div className="row">
                                        <div className="col-sm-6">
                                            ...
                                            <div
                                                className={this.state.formErrors.experience[index].company_name !== '' ? 'form-group global-error' : 'form-group'}>
                                                <label htmlFor="company_name" className="control-label">company
                                                    name</label>
                                                <input value={item.company_name}
                                                       onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                       onChange={(e) => this.handleUserInput(e, index)}
                                                       name="company_name" onKeyDown={(e) => this.limit(100, e)}
                                                       type="text" id="comp-name" className="form-control"
                                                       placeholder="Company Name"/>
                                                <p>
                                                    <span>{this.state.formErrors.experience[index].company_name !== '' ? this.state.formErrors.experience[index].company_name : ''}</span>
                                                </p>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div
                                                className={this.state.formErrors.experience[index].designation !== '' ? 'form-group global-error' : 'form-group'}>
                                                <label className="control-label">Title</label>
                                                <input value={item.designation}
                                                       onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                       onChange={(e) => this.handleUserInput(e, index)}
                                                       onKeyDown={(e) => this.limit(100, e)} name="designation"
                                                       type="text" id="designation" className="form-control"
                                                       placeholder="Title"/>
                                                <p>
                                                    <span>{this.state.formErrors.experience[index].designation !== '' ? this.state.formErrors.experience[index].designation : ''}</span>
                                                </p>
                                    ...
                                    <div className="row">
                                            ...
                                            <div className="row m-0">
                                                ...
                                                <ul className="list radio-list m-0">
                                                    <li className="list__item">
                                                        <input id={'a' + index} type="radio" className="radio-btn"
                                                               name={"Present" + index}
                                                               onChange={(e) => this.handleUserInput(e, index)}
                                                               checked={item.present === 'Y'} value='Y'/>
                                                        <label htmlFor={'a' + index} className="label p-0">Yes</label>
                                                    </li>
                                                    <li className="list__item m-10">
                                                        <input id={'b' + index} type="radio" className="radio-btn"
                                                               name={"Present" + index}
                                                               onChange={(e) => this.handleUserInput(e, index)}
                                                               checked={item.present === 'N'} value="N"/>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div className="form-group ml-0 mr-0 mb-0">
                                                ...
                                                <div className="row">
                                                    <div
                                                        className={this.state.formErrors.experience[index].start_date !== '' ? 'start-date form-group global-error col-xs-12 col-sm-6 mb-20' : 'start-date form-group col-xs-12 col-sm-6 mb-20'}>
                                                        <Datetime
                                                            onChange={(date) => this.handleDateChange(date, index, 'start_date')}
                                                        ...
                                                        {item.start_date ?
                                                            <span className="clear"
                                                                  onClick={(e) => this.handleDateChange('', index, 'start_date')}></span>
                                                            :
                                                            null
                                                        }
                                                        <p className="m-0">
                                                            <span>{this.state.formErrors.experience[index].start_date !== '' ? this.state.formErrors.experience[index].start_date : null}</span>
                                                        </p>
                                                    </div>
                                                    <div
                                                        className={item.present == 'Y' ? 'd-none' : this.state.formErrors.experience[index].end_date ? 'end-date form-group global-error  col-xs-12 col-sm-6 m-0' : 'end-date form-group col-xs-12 col-sm-6 m-0'}>
                                                        <Datetime ref={(dateTimeObj) => {
                                                            this._child = dateTimeObj;
                                                        }}
                                                                  onChange={(date) => this.handleDateChange(date, index, 'end_date')}
                                                                  value={item.end_date}
                                                                  input={true}
                                                                  inputProps={{
                                                                      placeholder: 'To',
                                                        ...
                                                        {item.end_date ?
                                                            <span className="clear"
                                                                  onClick={(e) => this.handleDateChange('', index, 'end_date')}></span>
                                                            :
                                                            null
                                                        }
                                                        <p>
                                                            <span>{this.state.formErrors.experience[index].end_date !== '' ? this.state.formErrors.experience[index].end_date : null}</span>
                                                        </p>
                                                    </div>
                                                    <span
                                                        className={item.present == 'Y' ? 'present form-group col-xs-12 col-sm-6' : 'd-none'}>Present</span>
                                                </div>
                                            </div>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            ...
                                            <div
                                                className={this.state.formErrors.experience[index].employment_type_id !== '' ? 'form-group global-error' : 'form-group'}>
                                                ...
                                                <p>
                                                    <span>{this.state.formErrors.experience[index].employment_type_id !== '' ? this.state.formErrors.experience[index].employment_type_id : ''}</span>
                                                </p>
                                        ...
                                        <div className="col-sm-6">
                                            <div
                                                className={this.state.formErrors.experience[index].experience_additional_information !== '' ? 'form-group global-error' : 'form-group'}>
                                                <label htmlFor="experience_additional_information"
                                                       className="control-label">additional information</label>
                                                <input value={item.experience_additional_information}
                                                       onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                       onChange={(e) => this.handleUserInput(e, index)}
                                                       name="experience_additional_information"
                                                       onKeyDown={(e) => this.limit(250, e)} type="text"
                                                       id="additional-info" className="form-control"
                                                       placeholder="Additional Information"/>
                                                <p>
                                                    <span>{this.state.formErrors.experience[index].experience_additional_information !== '' ? this.state.formErrors.experience[index].experience_additional_information : ''}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row">
                                        <div className="col-sm-6">
                                            <div className="form-group">
                                                <label htmlFor="skilled_used_other_text" className="control-label">Skills
                                                    Used</label>
                                                <Select
                                                    multi
                                                    closeOnSelect={false}
                                        ...
                                        <div className="col-sm-6">
                                            <div
                                                className={(item.showOthers == 'true' || item.showOthers == true) ? 'form-group' : 'form-group d-none'}>
                                                <label htmlFor="Others" className="control-label">Others</label>
                                                <input value={item.others}
                                                       onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                       onChange={(e) => this.handleUserInput(e, index)} name="others"
                                                       type="text" id="others" className="form-control"
                                                       placeholder="Others"/>
                                                <p>
                                                    <span>{this.state.formErrors.experience[index].others !== '' ? this.state.formErrors.experience[index].others : ''}</span>
                                                </p>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div className="row add-more-wrapper">
                                        <a className={index == (this.state.formVal.experience.length - 1) ? "add-more" : "add-more d-none"}
                                        ...
                                        <a className={index !== 0 ? "delete-more" : "delete-more d-none"}
                                           onClick={(e) => this.deleteExp(index, e)}><img
                        ...
                        <div className="nxt-prev-btns">
                            <button type="click" onClick={() => utils.changeUrl(routesPath['SEEKER_BASIC_INFO'])}
                                    className="previouse-btn btn pull-left mb-10">Previous
                            </button>
