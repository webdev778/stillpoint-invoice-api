                ...
                <div className="change-password content-wrapper container">
                    <form className="form change-password-form" onSubmit={this._handleClick}>
                        <div className="change-password-card card">
                            ...
                            <p className="hide">It’s a good idea to use a strong password that you don’t use
                                elsewhere.</p>
                            <div className="max-450">
                                <div className="row">
                                    <div className="col-xs-12">
                                        <div
                                            className={this.state.formErrors.old_password !== '' ? 'form-group global-error' : 'form-group'}>
                                            ...
                                            <div className="pwd-wrapper">
                                                <input type="password" id="crnt-pwd" className="pswd form-control"
                                                       ...
                                                       value={this.state.old_password} onBlur={this.handleInputOnBlur}
                                                       onChange={this.handleUserInput}/>
                                                <span onClick={this.showOldPassword} className="eye"><i
                                                    className={this.state.showOldPass ? "fa fa-eye" : "fa fa-eye-slash"}></i></span>

                                            </div>
                                            <p>
                                                <span>{this.state.formErrors.old_password !== '' ? this.state.formErrors.old_password : ''}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-xs-12">
                                        <div
                                            ...
                                            <div className="pwd-wrapper">
                                                <input type="password" id="new-pwd" className="pswd form-control"
                                                       ...
                                                       value={this.state.password} onBlur={this.handleInputOnBlur}
                                                       onChange={this.handleUserInput}/>
                                                <span onClick={this.showNewPassword} className="eye"><i
                                                    className={this.state.showNewPass ? "fa fa-eye" : "fa fa-eye-slash"}></i></span>
                                    ...
                                    <div className="col-xs-12">
                                        <div
                                            ...
                                            <label htmlFor="retype-pwd" className="control-label">Retype New
                                                Password</label>
                                            <div className="pwd-wrapper">
                                    ...
                                    <div className="btns col-xs-12">
                                        ...
                                        <button type="button" name="cancel" className="btn-negative pull-left m-0"
                                                onClick={() => utils.redirectionHandle()}> Cancel
                                        </button>
                                    </div>
                                </div>
                            </div>
