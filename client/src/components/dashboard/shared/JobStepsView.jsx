        ...
        return (
            <div>
                <div className="bg-white widget-wrapper clearfix">
                                ...
                                <li className={case_101}>
                                    <Link>
                                        <span className="round-tabs one"
                                              onClick={this.getStepData.bind(this, this.props.jobId, step_101, this.props.role, false)}></span>
                                    </Link>
                                    <span>{this.props.role === 'seeker' ? 'Applied' : 'Candidates'}</span><span></span>
                                </li>
                                <li className={case_102}>
                                    <Link>
                                        <span className="round-tabs tow"
                                              onClick={this.getStepData.bind(this, this.props.jobId, step_102, this.props.role, false)}></span>
                                    </Link>
                                ...
                                <li className={case_103}>
                                    <Link>
                                        <span className="round-tabs three"
                                              onClick={this.getStepData.bind(this, this.props.jobId, step_103, this.props.role, false)}></span>
                                    </Link>
                                ...
                                <li className={case_104}>
                                    <Link>
                                        <span className="round-tabs four"
                                              onClick={this.getStepData.bind(this, this.props.jobId, step_104, this.props.role, false)}></span>
                                    </Link>
                                ...
                                <li className={case_105}>
                                    <Link>
                                        <span className="round-tabs five"
                                              onClick={this.getStepData.bind(this, this.props.jobId, step_105, this.props.role, false)}></span>
                                    </Link>
                                ...
                                <li className={case_106}>
                                    <Link>
                                        <span className="round-tabs six"
                                              onClick={this.gotoJobCompleteStep.bind(this, step_106)}></span>
                                    </Link>
                    ...
                    <div>
                        {{
                            101: <Applied role={this.props.role} stepRelatedData={this.state.stepRelatedData}
                                          declinedCandidateList={this.state.declinedCandidateList}
                                          jobId={this.props.jobId} step={this.state.step}
                                          highestStep={this.state.highestStep} handler={this.handler}/>,
                            102: <Interviewing role={this.props.role} stepRelatedData={this.state.stepRelatedData}
                                               jobId={this.props.jobId} step={this.state.step}
                                               highestStep={this.state.highestStep} handler={this.handler}
                                               freezeActivity={this.props.freezeActivity}/>,
                            103: <NegotiatingTerms jobType={this.state.jobType} paymentType={this.state.paymentType}
                                                   role={this.props.role}
                                                   stepRelatedData={this.state.stepRelatedData[0] || {}}
                                                   jobId={this.props.jobId} step={this.state.step}
                                                   highestStep={this.state.highestStep} handler={this.handler}/>,
                            104: <StartPending jobType={this.state.jobType} paymentType={this.state.paymentType}
                                               role={this.props.role}
                                               stepRelatedData={this.state.stepRelatedData[0] || {}}
                                               jobId={this.props.jobId} step={this.state.step}
                                               highestStep={this.state.highestStep} handler={this.handler}
                                               freezeActivity={this.props.freezeActivity} userId={this.props.userId}/>,
                            105: <InProgress jobType={this.state.jobType} paymentType={this.state.paymentType}
                                             role={this.props.role} stepRelatedData={this.state.stepRelatedData}
                                             jobId={this.props.jobId} step={this.state.step}
                                             highestStep={this.state.highestStep} handler={this.handler}/>,
                            106: <JobComplete role={this.props.role} stepRelatedData={this.state.stepRelatedData}
