                        ...
                        <Dropdown.Menu className="super-colors">
                            {
                                eitherOneProfileCompleted ?
                                    <MenuItem eventKey="1"
                                              onClick={() => this.movePage(this.routesPath['PROFILE'] + '/attorney')}>
                            ...
                            }
                            {
                                eitherOneProfileCompleted ?
                                    <MenuItem eventKey="2"
                                              onClick={() => this.movePage(this.routesPath['PROFILE'] + '/firm')}>
            ...
            <div className="header-wrapper">
                <header className={'static-page-header home-page-header hidden-xs-down ' + homePageClass}>
                    <nav className="navbar navbar-fixed-top">
                        <div className="container-fluid row mt-15 pb-5">
                                        ...
                                        {this.state.role !== 'admin' ?
                                            eitherOneProfileCompleted ?
                                                <div className="navbar-mid-wraper col-xs-7 col-sm-6 pull-left p-0">
                                                    <button className="yellow-btn m-0" type="button"
                                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}> Post
                                                        a Job
                                                    </button>
                                                    <button className="yellow-btn ml-10" type="button"
                                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}> Find
                                                        a Job
                                                    </button>
                                                </div>
                                                :
                                            ...
                                            <ul className="pull-right">
                                                ...
                                                <li className="p-0">
                                                    <span className="profile-pic"><img
                                                        src={this.state.photo ? this.state.photo : constant['IMG_PATH'] + 'default-profile-pic.png'}
                                                        onError={this.profileImgError}/></span>
                                    ...
                                    <div className="row m-0">
                                        {
                                            !this.props.session ?
                                                <div className="navbar-mid-wraper col-xs-7 col-sm-6 pull-left p-0">
                                                    <button className={"mr-10 " + transButton} type="button"
                                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}> Post
                                                        a Job
                                                    </button>
                                                    <button className={"" + transButton} type="button"
                                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}> Find
                                                        a Job
                                                    </button>
                                                </div>
                                ...
                                <span className="user-name">{this.state.first_name} {this.state.last_name} 2</span>
                                                    ...
                                                    <ul className="pull-right">
                                                        <li className="sign-in-up mt-10">
                                                            <span><i className="fa fa-unlock-alt"
                    ...
                    <nav className="navbar navbar-fixed-top">
                        <div className="container-fluid row m-0">
                            <div className="navbar-header col-xs-4 m-0 p-0">
                                <a className="navbar-brand" href="javascript:void(0);">
                                    <img id="legably_logo" className="ml-0" onClick={this.onLegablyLogoClick}
                                         src={logoImage} alt="logo" width="160"/>
                                </a>
                            </div>
                        ...
                        !isHomePage ?
                            !this.props.session ?
                                <div className="navbar-mid-wraper">
                                    <button onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}
                                            className="yellow-btn" type="button"> Post a Job
                                    </button>
                                    <button
                                        onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}
                                        className="yellow-btn ml-10" type="button"> Find a Job
                                    </button>
                                </div>
                                :
                                eitherOneProfileCompleted ?
                                    <div className="navbar-mid-wraper">
                                        <button
                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}
                                            className="yellow-btn" type="button"> Post a Job
                                        </button>
                                        <button
                                            onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}
                            ...
                            !this.props.session ?
                                <div className="navbar-mid-wraper">
                                    <button onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}
                                            className="transy-btn" type="button"> Post a Job
                                    </button>
                                    <button
                                        onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}
                                        className="transy-btn ml-10" type="button"> Find a Job
                                    </button>
                                </div>
                                :
                                null
