          ...
          <div className="container">
            ...
            <div className="col-md-6 text-right">
              <div className="hero-container">
                <img src="../images/dan.png" alt="Dan Reilly"></img>
            ...
            <div className="col-md-6">
              <div className="hero-container">
                <div className="hero-img-wrapper"><img src="../images/bill.jpg" alt="Bill Maya"></img></div>
