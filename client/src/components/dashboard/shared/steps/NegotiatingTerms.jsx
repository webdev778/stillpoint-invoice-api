...
export default class NegotiatingTerms extends React.Component {
    ...
    calculateTotalAmount() {
        ...
        this.setState({
            stepRelatedData: jobObj,
            legablyServiceCharges: this.state.legablyServiceCharges,
            formError: formError
        });
    }
                            ...
                            <div>
                                {
                                    isTermAccepted ?
                                        <div className="status-content mt-45">
                                            ...
                                            <p>Here are the job terms that you and the hiring manager have agreed
                                                upon.</p>
                                        </div>
                                        :
                                        <div className="status-content mt-45">
                                            <h6>Here are the terms proposed by the hiring manager.</h6>
                                            <p>To accept the terms and get started please click the Accept Terms button.
                                                To request changes to the terms please click the Send Message Proposing
                                                New Terms button and send a message to the hiring manager telling them
                                                how you'd like the terms modified.</p>
                                        </div>
                                }
                                    ...
                                    <form>
                                        ...
                                        <div className="card">
                                                    ...
                                                    <ul className="tabbed-radio-btns">
                                                        <li>
                                                            <input type="radio" name="h-f"
                                                                   defaultChecked={stepRelatedData.rateType == utils.ENUM.RATE_TYPE.HOURLY ? 1 : 0}
                                                        ...
                                                        <li>
                                                            <input type="radio" name="h-f"
                                                                   defaultChecked={stepRelatedData.rateType == utils.ENUM.RATE_TYPE.FIXED ? 1 : 0}
                                            ...
                                            <div className="posting-two-cols hours-col">
                                                <div className="form-group">
                                                    <label className="control-label">ESTIMATED HOURS OF WORK
                                                        REQUIRED*</label>
                                                    <div className="inline-to-block">
                                                        <input type="text" className="form-control custom-num"
                                                               placeholder="00" defaultValue={stepRelatedData.hours}
                                                               readOnly/>
                                                    </div>
                                                            ...
                                                            {this.state.employment_type_dropdown.map((hoursType, index) =>
                                                                <li key={index}>
                                                                    <input type="radio" name="pt-ft"
                                                                           defaultChecked={hoursType.value == stepRelatedData.hoursType ? 1 : 0}
                                            ...
                                            <div className="estimated-section">
                                                <div className="row">
                                                    <div className="col-sm-4">
                                                        <div className="form-group">
                                                            <label className="control-label">ESTIMATED AMOUNT PAYABLE TO
                                                                CANDIDATE</label>
                                                            <input type="text" className="form-control amount-dollar-bg"
                                                                   placeholder="Total"
                                                                   defaultValue={stepRelatedData.subTotal} readOnly/>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                {stepRelatedData.paymentDetails.map((payment, index) =>
                                                    <ul className="payment-details row" key={index}>
                                                        <li className="col-sm-4">
                                                            ...
                                                            <input type="text"
                                                                   className="form-control amount-dollar-bg custom-num"
                                                                   placeholder="Payment"
                                                        ...
                                                        <li className="col-sm-4">
                                                            ...
                                                            <input type="text" className="form-control"
                                                                   ...
                                                                   defaultValue={payment.delivery || ''} readOnly/>
                                                        </li>
                                                        ...
                                                        <li className="col-sm-4">
                                                            ...
                                                            <div className="rdt">
                                                                <input type="text" className="form-control"
                                                                       ...
                                                                       placeholder="Due Date" name="searchStartDate"
                                                                       readOnly/>
                                        ...
                                        <div className="text-right d-block p-0">
                                            {
                                                this.state.highestStep === constant['JOB_STEPS']['J_COMPLETE'] ?
                                                    ...
                                                    <button type="button" className="btn-primary btn"
                                                            onClick={this.onSendMsgBtnClick.bind(this, null)}>Send
                                                        Message Proposing New Terms</button>
                                            }
                                            {
                                                isTermAccepted ?
                                                    null
                                                    ...
                                                    <button type="button" className={primaryBtn}
                                                            onClick={this.onAcceptTermsBtnClick.bind(this, jobId, constant['JOB_STEPS']['S_PENDING'], stepRelatedData.seekerId)}>Accept
                                                        Terms</button>
                                            }
                                        </div>
                                        <span className="clearfix"></span>
                                        ...
                                        <div className="status-content proposed-terms-footer">
                                            ...
                                            <div className="btn p-0 m-0">
                                                <button type="button" className={withdrawBtn}
                                                        onClick={this.onWithdrawBtnClick.bind(this, jobId, (constant['JOB_STEPS']['N_TERMS'] * -1), stepRelatedData.seekerId, constant['ROLE']['SEEKER'])}>Withdraw
                                                    From Consideration
                                                </button>
                                            </div>
                                            <p className="d-inline-block m-0 pb-10">To remove yourself from
                                                consideration for this job click the Withdraw From Consideration
                                                button.</p>
                                        </div>
                                }
                            </div>
                    ...
                    <div>
                        {
                            isTermAccepted ?
                                ...
                                <div className="status-content mt-45">
                                    ...
                                    <p>To move forward, please propose your terms below and click the Submit Terms
                                        button to send them to {seekerName} for review and acceptance. If you want to
                                        send a message to {seekerName} during the negotiating process click the Send
                                        Message button.</p>
                                    <p className="mt-10">Once your candidate has accepted your proposed terms, we’ll let
                                        you know!</p>
                                </div>
                        }
                        ...
                        <div className="proposed-terms status-content mt-30">
                                ...
                                <div className="card m-0">
                                        ...
                                        <div className="form-group">
                                            ...
                                            <div
                                                ...
                                                <input type="text"
                                                       className="form-control amount-dollar-bg text-left custom-num"
                                                       placeholder="Rate"
                                                       value={stepRelatedData.rate}
                                                       onChange={(e) => this.validateData(e, 'rate', 999999)}
                                                       onBlur={(e) => this.handleOnBlur(e, 'rate')}
                                                       readOnly={isTermAccepted}/>
                                                {this.state.formError.rate ?
                                                    <p><span> {this.state.formError.rate} </span></p> : ''}
                                            </div>
                                            <ul className="tabbed-radio-btns">
                                                <li>
                                                    <input type="radio" name="h-f"
                                                           checked={stepRelatedData.rateType == utils.ENUM.RATE_TYPE.HOURLY ? 1 : 0}
                                                           value={utils.ENUM.RATE_TYPE.HOURLY}
                                                           onChange={(e) => this.validateData(e, 'rateType', '')}
                                                           disabled={isTermAccepted}/>
                                                    <span>Hourly</span>
                                                </li>
                                                <li>
                                                    <input type="radio" name="h-f"
                                                           checked={stepRelatedData.rateType == utils.ENUM.RATE_TYPE.FIXED ? 1 : 0}
                                    ...
                                    <div className="posting-two-cols hours-col">
                                        <div className="form-group">
                                            ...
                                            <div
                                                className={this.state.formError.hours && stepRelatedData.rateType != utils.ENUM.RATE_TYPE.FIXED ? 'global-error inline-to-block' : 'inline-to-block'}>
                                                <input type="text" className="form-control custom-num" placeholder="00"
                                                       value={stepRelatedData.hours}
                                                       onChange={(e) => this.validateData(e, 'hours', 999)}
                                            ...
                                            <div className="pt-ft-w-m">
                                                <ul className="tabbed-radio-btns">
                                                    {this.state.employment_type_dropdown.map((hoursType, index) =>
                                                        <li key={index}>
                                                            <input type="radio" name="pt-ft"
                                                                   checked={hoursType.value == stepRelatedData.hoursType ? 1 : 0}
                                                                   value={hoursType.value}
                                                                   onChange={(e) => this.validateData(e, 'hoursType', '')}
                                                                   disabled={this.state.disableHours || isTermAccepted}/>
                                                            <span>{hoursType.label}</span>
                                                        </li>
                                                    )}
                                                </ul>
                                    ...
                                    <div className="estimated-section">
                                        <div className="row">
                                            <div className="col-sm-6">
                                                <div
                                                    className={this.state.formError.subTotal ? 'global-error form-group' : 'form-group'}>
                                                    <label className="control-label">ESTIMATED AMOUNT PAYABLE TO
                                                        CANDIDATE</label>
                                                    <input type="text" className="form-control amount-dollar-bg"
                                                           placeholder="Total"
                                            ...
                                            <ul className="payment-details row" key={index}>
                                                <li className={payment.errorMessage ? 'global-error col-sm-4' : 'col-sm-4'}>
                                                    ...
                                                    <input type="text"
                                                           ...
                                                           placeholder="Payment"
                                                           value={payment.rate}
                                                           onChange={(e) => this.validatePaymentData(e, 'rate', index, 999999)}
                                                           readOnly={isTermAccepted}/>
                                                ...
                                                <li className="col-sm-4 mb-15">
                                                    ...
                                                    <input type="text" className="form-control"
                                                           ...
                                                           onChange={(e) => this.validatePaymentData(e, 'delivery', index, '')}
                                                           readOnly={isTermAccepted}/>
                                                </li>
                                                ...
                                                <li className={payment.errorMessageDueDate ? 'global-error col-sm-4' : 'col-sm-4'}>
                                                    ...
                                                    <div className="rdt">
                                                        {
                                                            isTermAccepted ?
                                                                ...
                                                                <div>
                                                                    <Datetime
                                                                        onChange={(date) => this.validatePaymentData(date, 'dueDate', index, '')}
                                                    ...
                                                    <p className="static">
                                                        <span>{payment.errorMessageDueDate || ''}</span></p>
                                                </li>
                                        ...
                                        <ul className="remaining-detail remaining-button-bar mb-0">
                                            <li className="mb-0">
                                                ...
                                                <input type="text" className="form-control amount-dollar-bg"
                                                       placeholder="Remaining" value={this.state.remainingAmount}
                                                       readOnly/>
                                            </li>
                                        </ul>
                                    </div>
                            ...
                            <div>
                                ...
                                <p>
                                    ...
                                    <span
                                        className="pull-right">{isNaN((parseFloat(stepRelatedData.subTotal)).toFixed(2)) ? "$00.00" : '$' + stepRelatedData.subTotal}</span>
                                    <span className="clearfix"></span>
                                </p>
                                <p>
                                    <span className="pull-left">Estimated Legably service charge:</span>
                                    <span
                                        className="pull-right">{isNaN((parseFloat(this.state.legablyServiceCharges)).toFixed(2)) ? '$0.00' : '$' + parseFloat(this.state.legablyServiceCharges).toFixed(2)}</span>
                                    <span className="clearfix"></span>
                                </p>
                                <p className="clearfix grand-total">
                                    <span className="pull-left">Estimated total cost</span>
                                    <span
                                        className="pull-right">{isNaN((parseFloat(stepRelatedData.total)).toFixed(2)) ? '$00.00' : '$' + parseFloat(stepRelatedData.total).toFixed(2)}</span>
                                    <span className="clearfix"></span>
                                </p>
                            </div>
                            }
                            <div className="d-block remain-buttons text-right">
                                {
                                    this.state.highestStep === constant['JOB_STEPS']['J_COMPLETE'] ?
                                        ...
                                        :
                                        <button type="button" className="btn-primary btn"
                                                onClick={this.onSendMsgBtnClick.bind(this, stepRelatedData.seekerId)}>Send
                                            Message</button>
                                }
                                {
                                    isTermAccepted ?
                                        ...
                                        :
                                        <button type="button" className={primaryBtn}
                                                onClick={this.submitTerms.bind(this)}>Submit Terms</button>
                                }
                            </div>
                        </div>
                        {/*proposed-terms*/}
                        {
                            isTermAccepted ?
                                ...
                                <div className="status-content proposed-terms-footer">
                                    ...
                                    <div className="btn p-0 m-0">
                                        <button type="button" className={withdrawBtn}
                                                onClick={this.onWithdrawBtnClick.bind(this, jobId, (constant['JOB_STEPS']['N_TERMS'] * -1), stepRelatedData.seekerId, constant['ROLE']['POSTER'])}>Withdraw
                                            From Consideration
                                        </button>
                                    </div>
                                    <p className="d-inline-block m-0 pb-10">To remove this candidate from consideration
                                        for this job click the Withdraw From Consideration button.</p>
                                </div>
                        }
                    </div>
                }
