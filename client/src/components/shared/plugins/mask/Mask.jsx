...
export default class Mask extends React.Component {
    ...
    render() {
        return (
            <div>
                <input type="text" value={this.state.value} name={this.state.name} className="form-control"
                       onBlur={this.handleBlur} placeholder={this.state.placeholder} onChange={this.handleChange}
                       ref="maskedInput"></input>
            </div>
        );
    }
}
