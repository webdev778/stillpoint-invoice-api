            ...
            if (err) {
                ...
                if (utils.isResSuccess(response)) {
                    ...
                    for (let degreesObj of data['degrees']) {
                        degrees.push(<option key={degreesObj['_id']}
                                             value={degreesObj['_id']}>{degreesObj['name']}</option>);
                    }
    ...
    render() {
        return (
            <Role step="basic_info_edu" role="seeker" profileStatus={this.state.completeStatus}>
                <div>
                    <div className="visible-xs mobile-page-heading">Basic Info + Education<span
                        onClick={() => utils.changeUrl(constant['ROUTES_PATH']['SEEKER_EXEPERIENCE'])}
                        className={this.state.completeStatus >= 1 ? 'next' : 'next disabled-element'}></span></div>
                        ...
                        <div className="basic-info-form">
                            ...
                            <div className="basic-info-card card">
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <input onChange={this.handleUserInput} onBlur={this.handleInputOnBlur}
                                                   type="text" name="first_name" value={this.state.formVal.first_name}
                                                   id="fname" className="form-control" placeholder="First Name"/>
                                            <p>
                                                <span>{this.state.formErrors.first_name !== '' ? this.state.formErrors.first_name : ''}</span>
                                            </p>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div
                                            ...
                                            <input onChange={this.handleUserInput} name="last_name"
                                                   onBlur={this.handleInputOnBlur} type="text"
                                                   value={this.state.formVal.last_name} id="lname"
                                                   className="form-control" placeholder="Last Name"/>
                                            <p>
                                                <span>{this.state.formErrors.last_name !== '' ? this.state.formErrors.last_name : ''}</span>
                                            </p>
                                ...
                                <div className="row">
                                    <div className="col-sm-12">
                                        ...
                                        <div
                                            className={this.state.formErrors.street_address !== '' ? 'form-group global-error' : 'form-group'}>
                                            <label className="control-label">street address*</label>
                                            <textarea onBlur={this.handleInputOnBlur} name="street_address"
                                                      value={this.state.formVal.street_address}
                                                      onChange={this.handleUserInput} className="form-control"
                                                      placeholder="Street Address"></textarea>
                                            <p>
                                                <span>{this.state.formErrors.street_address !== '' ? this.state.formErrors.street_address : ''}</span>
                                            </p>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <div
                                            className={this.state.formErrors.city !== '' ? 'form-group global-error' : 'form-group'}>
                                            <label htmlFor="city" className="control-label">City*</label>
                                            <input onBlur={this.handleInputOnBlur} type="text" name="city"
                                                   value={this.state.formVal.city} id="city"
                                                   onChange={this.handleUserInput} className="form-control"
                                                   placeholder="City"/>
                                            <p>
                                                <span>{this.state.formErrors.city !== '' ? this.state.formErrors.city : ''}</span>
                                            </p>
                                    ...
                                    <div className="col-sm-6">
                                        ...
                                        <div
                                            className={this.state.formErrors.state_id !== '' ? 'form-group global-error' : 'form-group'}>
                                            <label htmlFor="" className="control-label">State*</label>
                                            <div className="select-wrapper">
                                                <select onBlur={this.handleInputOnBlur} className="select-simple"
                                                        name="state_id" value={this.state.formVal.state_id}
                                            ...
                                            <p>
                                                <span>{this.state.formErrors.state_id !== '' ? this.state.formErrors.state_id : ''}</span>
                                            </p>
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        ...
                                        <div
                                            className={this.state.formErrors.zipcode !== '' ? 'form-group global-error' : 'form-group'}>
                                            <label htmlFor="zipcode" className="control-label">zip Code*</label>
                                            <input onBlur={this.handleInputOnBlur} type="text" name="zipcode"
                                                   value={this.state.formVal.zipcode} id="zipcode"
                                                   onChange={this.handleUserInput} className="form-control"
                                                   placeholder="Zip Code"/>
                                            <p>
                                                <span>{this.state.formErrors.zipcode !== '' ? this.state.formErrors.zipcode : ''}</span>
                                            </p>
                                    ...
                                    <div className="col-sm-6">
                                        <div
                                            className={this.state.formErrors.phone_number !== '' ? 'form-group global-error' : 'form-group'}>

                                            <label htmlFor="phone_number" className="control-label">Phone
                                                Number*</label>

                                            <Mask dataValue={this.state.formVal.phone_number} isReverse={false}
                                                  mask={"000-000-0000"} nameValue="phone_number"
                                                  placeholderValue="Phone Number" onMaskBlur={this.handleInputOnBlur}
                                                  onMaskChange={this.getMaskedVal}/>
                                            <p>
                                                <span>{this.state.formErrors.phone_number !== '' ? this.state.formErrors.phone_number : ''}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    return <div key={index}>
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                ...
                                                <div
                                                    className={this.state.formErrors.education[index].school !== '' ? 'form-group global-error' : 'form-group'}>
                                                    <label className="control-label">School*</label>
                                                    <input type="text" id="school" name="school"
                                                           onBlur={(e) => this.handleInputOnBlur(e, index)} key={index}
                                                           onChange={(e) => this.handleUserEduInput(index, e)}
                                                           value={item.school} className="form-control"
                                                           placeholder="School"/>
                                                    <p>
                                                        <span>{this.state.formErrors.education[index].school !== '' ? this.state.formErrors.education[index].school : ''}</span>
                                                    </p>
                                            ...
                                            <div className="col-sm-6">
                                                ...
                                                <div
                                                    className={this.state.formErrors.education[index].degree_id !== '' ? 'form-group global-error' : 'form-group'}>
                                                    <label htmlFor="" className="control-label">Degree*</label>
                                                    <div className="select-wrapper">
                                                        <select className="form-control pmd-select2"
                                                                onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                                onChange={(e) => this.handleUserEduInput(index, e)}
                                                                name="degree_id" value={item.degree_id}>
                                                    ...
                                                    <p>
                                                        <span>{this.state.formErrors.education[index].degree_id !== '' ? this.state.formErrors.education[index].degree_id : ''}</span>
                                                    </p>
                                        ...
                                        <div className="row">
                                            <div className="col-sm-6">
                                                ...
                                                <div
                                                    className={this.state.formErrors.education[index].year !== '' ? 'form-group global-error' : 'form-group'}>
                                                    <label className="control-label">Year Graduated*</label>
                                                    <input type="text" id="ygraduated"
                                                           onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                           onChange={(e) => this.handleUserEduInput(index, e)}
                                                           name="year" value={item.year} className="form-control"
                                                           placeholder="Select Year Graduated"/>
                                                    <p>
                                                        <span>{this.state.formErrors.education[index].year !== '' ? this.state.formErrors.education[index].year : ''}</span>
                                                    </p>
                                            ...
                                            <div className="col-sm-6">
                                                ...
                                                <div
                                                    className={this.state.formErrors.education[index].education_additional_information !== '' ? 'form-group global-error' : 'form-group'}>
                                                    <label className="control-label">Additional Information</label>
                                                    <input type="text" onKeyDown={(e) => this.limit(248, e)}
                                                           id="add-info"
                                                           onChange={(e) => this.handleUserEduInput(index, e)}
                                                           onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                    ...
                                                    <p>
                                                        <span>{this.state.formErrors.education[index].education_additional_information !== '' ? this.state.formErrors.education[index].education_additional_information : ''}</span>
                                                    </p>
                                        ...
                                        <div className="row add-more-wrapper">
                                            <a className={index == (this.state.formVal.education.length - 1) ? "add-more" : "add-more d-none"}
                                               onClick={this.createEducationContainer}><img
                                                src={constant['IMG_PATH'] + 'add-more-icon.png'} alt="add more"/>Add
                                                More</a>
                                            <a className={index != 0 ? "delete-more" : "d-none delete-more"}
                                               onClick={(e) => this.deleteEdu(index, e)}><img
                                                src={constant['IMG_PATH'] + 'delete-more.png'}
                                                alt="delete more"/> Delete</a>
                                        </div>
                                    </div>
                                })}
                                    ...
                                    return <div className="row" key={index}>
                                        <div className="col-sm-6">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div
                                                    className={this.state.formErrors.bar_admission[index].bar_state_id !== '' ? 'select-wrapper global-error' : 'select-wrapper'}>
                                                    <select className="form-control pmd-select2"
                                                            onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                            onChange={(e) => this.handleUserBarAdInput(index, e)}
                                                            name="bar_state_id" value={item.bar_state_id}>
                                                        <option value="">Select State</option>
                                                        {this.state.state_dropdown}
                                                    </select>
                                                    <p>
                                                        <span>{this.state.formErrors.bar_admission[index].bar_state_id !== '' ? this.state.formErrors.bar_admission[index].bar_state_id : ''}</span>
                                                    </p>
                                        ...
                                        <div className="col-sm-6">
                                            ...
                                            <div
                                                className={this.state.formErrors.bar_admission[index].bar_registration_number !== '' ? 'form-group global-error' : 'form-group'}>
                                                <label className="control-label">bar registration number*</label>
                                                <input type="text" onBlur={(e) => this.handleInputOnBlur(e, index)}
                                                       id="bar-reg-num" name="bar_registration_number"
                                                       onChange={(e) => this.handleUserBarAdInput(index, e)}
                                                       className="form-control uppercase"
                                                       placeholder="Bar Registration Number"
                                                       value={item.bar_registration_number}/>
                                                <p>
                                                    <span>{this.state.formErrors.bar_admission[index].bar_registration_number !== '' ? this.state.formErrors.bar_admission[index].bar_registration_number : ''}</span>
                                                </p>
                                        ...
                                        <div className="row add-more-wrapper m-0">
                                            <a className={index == (this.state.formVal.bar_admission.length - 1) ? "add-more" : "add-more d-none"}
                                               onClick={this.createBarAdmissionContainer}><img
                                                src={constant['IMG_PATH'] + 'add-more-icon.png'} alt="add more"/>Add
                                                More</a>
                                            <a className={index !== 0 ? "delete-more" : "delete-more d-none"}
                                               onClick={(e) => this.deleteBar(index, e)}><img
                                                src={constant['IMG_PATH'] + 'delete-more.png'}
                                                alt="delete more"/> Delete</a>
                                        </div>
                            ...
                            <div className="practice-area-card card">
                                ...
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div
                                            className={this.state.formErrors.practice_area_id !== '' ? 'form-group global-error' : 'form-group'}>
                                            ...
                                            />
                                            <p>
                                                <span>{this.state.formErrors.practice_area_id !== '' ? this.state.formErrors.practice_area_id : ''}</span>
                                            </p>
                                        </div>
                                    </div>
                                    <div className="col-sm-6">
                                        <div
                                            className={this.state.formErrors.skill_used_id !== '' ? 'form-group global-error' : 'form-group'}>
                                            ...
                                            />
                                            <p>
                                                <span>{this.state.formErrors.skill_used_id !== '' ? this.state.formErrors.skill_used_id : ''}</span>
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                <div className="row">
                                    <div className="col-sm-6">
                                        <div
                                            className={(this.state.formVal.showOthers == 'true' || this.state.formVal.showOthers == true) ? 'form-group' : 'form-group d-none'}>
                                            <label htmlFor="Others" className="control-label">Other Skills</label>
                                            <input value={this.state.formVal.others}
                                                   onBlur={(e) => this.handleInputOnBlur(e)}
                                                   onChange={(e) => this.handleUserInput(e)} name="other" type="text"
                                                   id="others" className="form-control"
                                                   placeholder="Other Skills Needed"/>
                                            <p>
                                                <span>{this.state.formErrors.others !== '' ? this.state.formErrors.others : ''}</span>
                                            </p>
                                        </div>
                                        ...
                                        <div className="radio-btns" style={this.state.showHide}>
                                            <ul className="list radio-list m-0 p-0">
                                                <li className="list__item">
                                                    <input id='yes' type="radio" className="radio-btn"
                                                           name="do_you_have_malpractice_insurance"
                                                           onChange={this.handleUserInput}
                                                           checked={this.state.formVal.do_you_have_malpractice_insurance === 'Y'}
                                                           value="Y"/>
                                                    <label htmlFor='yes' className="label p-0 m-0">Yes</label>
                                                </li>
                                                <li className="list__item">
                                                    <input id='no' type="radio" className="radio-btn"
                                                           name="do_you_have_malpractice_insurance"
                                                           onChange={this.handleUserInput}
                                                           checked={this.state.formVal.do_you_have_malpractice_insurance === 'N'}
                                                           value="N"/>
                            ...
                            <div className="nxt-prev-btns">
                                <div className={this.state.editProfile == true ? "d-block" : "d-none"}>
                                    <button type="button" name="save&Next"
                                            className="nxt-btn btn-primary btn pull-right"
                                            onClick={this.handleInfoSubmit}> Save & Next
                                    </button>
                                    <button type="button" name="save"
                                            className="nxt-btn btn-primary btn pull-right mr-1p"
                                            onClick={this.handleInfoSubmit}> Save
                                    </button>
                                    <button type="button" className="nxt-btn btn-default btn pull-right mr-1p"
                                            onClick={() => utils.refreshPage()}> Cancel
                                    </button>
                                </div>
                                <button type="submit" name="save&Next"
                                        className={this.state.editProfile == true ? "d-none nxt-btn btn pull-right" : "d-block nxt-btn btn-primary btn pull-right"}
                                        onClick={this.handleInfoSubmit}> Next
                                </button>
                            </div>
                        </div>
                    </form>
