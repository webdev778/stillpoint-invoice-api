                ...
                <div className="footer-container row">
                    ...
                    <div className="footer-right col-sm-9">
                        <ul className="list-inline">
                            ...
                            <li className="list-inline-item"><Link to={routesPath['COMPANY_OVERVIEW']}>About Us</Link>
                            </li>
                            <li className="list-inline-item"><Link to={routesPath['SUPPORT_CENTER']}>Support and
                                Suggestions</Link></li>
                            <li className="list-inline-item"><Link to={routesPath['TERMS_OF_SERVICE']}>Terms of
                                Service</Link></li>
                            <li className="list-inline-item"><Link to={routesPath['PRIVACY_POLICY']}>Privacy
                                Policy</Link></li>
                        </ul>
                    </div>
