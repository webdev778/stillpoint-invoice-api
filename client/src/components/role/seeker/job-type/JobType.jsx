        ...
        return (
            <Role step="job_type" role="seeker" profileStatus={this.state.completeStatus}>
                <div className="visible-xs mobile-page-heading"><span className="previous"
                                                                      onClick={() => utils.changeUrl(routesPath['SEEKER_HEADLINE'])}></span> Job
                    Type<span className={this.state.completeStatus >= 4 ? 'next' : 'next disabled-element'}
                              onClick={() => utils.changeUrl(routesPath['SEEKER_GET_STARTED'])}></span></div>
                    ...
                    <div className="job-card card">
                        ...
                        <div className="work-within checkbox pmd-default-theme row m-0">
                            <label className="pmd-checkbox col-sm-3 pt-5">
                                <input ref="willing_to_work_locally" value={this.state.formData.willing_to_work_locally}
                                       name="willing_to_work_locally" onChange={this.handleInput.bind(this)}
                                       type="checkbox"/><span className="pmd-checkbox-label">&nbsp;</span>
                                <span>Willing to work in</span>
                            </label>

                            <div
                                className={this.state.formErrors.willing_to_work_location_id !== '' ? 'select-parent col-sm-6 global-error' : 'select-parent col-sm-6'}>
                                <Select
                                    multi
                                    closeOnSelect={false}
                                ...
                                />
                                <span
                                    className="col-sm-3 pl-0 full-width clr">{this.state.formErrors.willing_to_work_location_id !== '' ? this.state.formErrors.willing_to_work_location_id : ''}</span>
                            </div>
                        ...
                        <div className="work-remotely checkbox pmd-default-theme m-0">
                            <label className="pmd-checkbox">
                                <input ref="willing_to_work_remotely" type="checkbox"
                                       value={this.state.formData.willing_to_work_remotely}
                                       name="willing_to_work_remotely" onChange={this.handleInput.bind(this)}/><span
                                className="pmd-checkbox-label">&nbsp;</span>
                        ...
                        <div className="work-part-time checkbox pmd-default-theme">
                            <label className="pmd-checkbox">
                                <input ref="willing_to_work_part_time" type="checkbox"
                                       value={this.state.formData.willing_to_work_part_time}
                                       name="willing_to_work_part_time" onChange={this.handleInput.bind(this)}/><span
                                className="pmd-checkbox-label">&nbsp;</span>
                        ...
                        <div className="work-full-time checkbox pmd-default-theme">
                            <label className="pmd-checkbox">
                                <input ref="willing_to_work_full_time" type="checkbox"
                                       value={this.state.formData.willing_to_work_full_time}
                                       name="willing_to_work_full_time" onChange={this.handleInput.bind(this)}/><span
                                className="pmd-checkbox-label">&nbsp;</span>
                        ...
                        <div className="work-permanent checkbox pmd-default-theme">
                            <label className="pmd-checkbox">
                                <input ref="work_permanent" name="work_permanent" type="checkbox"
                                       value={this.state.work_permanent} onChange={this.handleInput.bind(this)}/><span
                                className="pmd-checkbox-label">&nbsp;</span>
                ...
                <span id="pmd-slider-permanent-rate"
                ...
                <span className="range-value text-right ">
                  <span id="permanent-value-max"></span>
                        ...
                        <div className="work-contract checkbox pmd-default-theme">
                            <label className="pmd-checkbox">
                                <input ref="work_contract" name="work_contract" type="checkbox"
                                       value={this.state.work_contract} onChange={this.handleInput.bind(this)}/><span
                                className="pmd-checkbox-label">&nbsp;</span>
                ...
                <span id="pmd-slider-contract-rate"
                      className="pmd-range-slider noUi-target noUi-ltr noUi-horizontal noUi-background"></span>
                ...
                <span className="range-value text-right ">
                  <span id="contract-value-max"></span>
                    ...
                    <div className="nxt-prev-btns">
                        <button type="button" onClick={() => utils.changeUrl(routesPath['SEEKER_HEADLINE'])}
