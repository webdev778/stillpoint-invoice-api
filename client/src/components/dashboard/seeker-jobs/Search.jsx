        ...
        const jobs = jobRecords.map(function (job) {
            ...
            return (
                <Job key={job._id} job={job} userRelatedData={this.state.userRelatedData}
                     freezeActivity={this.state.freezeActivity} isBarIdValid={this.state.isBarIdValid}/>
            )
        }.bind(this));
                    ...
                    <div className="job-search-card mb-30 column-flex">
                        ...
                        <div className="search-filter-box m-30">
                            <div className="date-filter-box">
                                <Dropdown onSelect={this.handleOrderSelect} className='dropdown-container'
                            ...
                            <div>
                                ...
                                <button type="button" className="btn ml-10 btn-primary mt-30"
                                        onClick={this.handleSearch}>
                                    Search
                                </button>
                            </div>
                        </div>
                        {this.state.isResponse ? (jobRecordsLength > 0 ? <div>{jobs}</div> :
                            <NoRecordFound name="Jobs"/>) : null}
                    </div>
