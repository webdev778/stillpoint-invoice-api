                ...
                if (err) {
                    ...
                    if (utils.isResSuccess(response)) {
                        if (_this.state.rememeberMe) {
                            cookieManager.setObject('rememeberMe', {
                                email: data.email,
                                password: btoa(_this.state.password)
                            });
                        } else {
                ...
                <section className="right-section sign-in-section pull-right">
                    <div className="white-logo-bg">
                        <img onClick={() => utils.goToHome()}
                             src={constant['IMG_PATH'] + 'primaryHorizontalRgb@2x.jpg'} alt="leably-white-logo"
                             className="img-responsive mobile-on-logo" width="120" height="31"/>
                    </div>
                    <div className="form-wrapper">
                        ...
                        <form className="sign-in-form" onSubmit={this._handleClick}>
                            ...
                            <div className="form-group checkbox mb-35">
                                <label className="pmd-checkbox">
                                    <input type="checkbox" name="rememeberMe" checked={this.state.rememeberMe}
                                           onChange={this.handleInputChange}/><span
                                    className="pmd-checkbox-label">&nbsp;</span>Remember me
                                </label>
                        ...
                        <div className="already-signed">Don’t have an account? <Link to={routesPath['SIGN_UP']}>Sign
                            Up</Link></div>
                    </div>
                </section>
