        ...
        return (
            <div className="send-msg-modal">
                ...
                <div className="modal-body m-0">
                    <form>
                        <div
                            className={this.state.formErrors.subject === true ? 'form-group m-0 global-error' : 'form-group m-0'}>
                        ...
                        <div
                            className={this.state.formErrors.msg === true ? 'form-group m-0 global-error' : 'form-group m-0'}>
              <textarea name="msg" className="full-width mt-20" rows="7" placeholder="Your Message..."
                        ...
                        <div
                            className={this.state.formErrors.fileErr === true ? 'form-group m-0 global-error' : 'form-group m-0'}>
                            <DragDropFile handler={this.handler} title="Attach File (Optional)"
                ...
                <div className="modal-footer">
                    ...
                    <button className="btn-primary btn pull-right" onClick={() => this.onYesBtnClick()}>Send Message
                    </button>
                </div>
            </div>
        )
