            ...
            <div className="bg-white">
                ...
                <div className="content-wrapper container terms-of-service">
                    ...
                    <div className="static-panel-div">
                        ...
                        this page. All Site visitors and users of the Service should routinely visit this page to view
                        the
                        ...
                        adhering to all relevant and applicable rules regarding the handling of any and all
                        conflicts-of-
                        interest. Legably is not responsible for any apparent or actual conflicts-of- interest that may
                        or
                        may not exist.<br/><br/>
                        ...
                        <ul>
                            <li>Provide your full legal name, a valid email address, your valid attorney identification
                                information where applicable and any other information requested in order to complete
                                the signup process accurately.
                            </li>
                            <li>Accurately and proactively report any previous, current or pending disciplinary
                                action.
                            </li>
                            <li>Use only a single username and password (&quot;login&quot;). You cannot share an
                                account.
                            </li>
                            <li>Keep your password secure—Legably cannot and will not be liable for any loss or damage
                                from your failure to maintain the security of your account and password.
                            </li>
                            <li>Notify Legably immediately if you suspect any security breaches to your account or the
                                Legably system.
                            </li>
                            <li>Be responsible for all activity and content (including, but not limited to, data,
                                graphics, photos, and links) that is uploaded under your Service account.
                            </li>
                            <li>Read, understand, agree to and abide by all parts of these Terms of Service.</li>
                            <li>Perform obligations as specified by this agreement and agreements that you enter into
                                through the Service when not in conflict with these Terms of Service or prohibited by
                                law.
                            </li>
                            <li>Represent and warrant that your user content and Legably’s use thereof in the context of
                                these Terms of Service and the Service will not infringe upon the Intellectual Property
                                Rights, Privacy Rights or Publicity rights of any third party.
                            </li>
                            <li>Represent and warrant that you have the written consent of each and every identifiable
                                natural person in the user content to use such person’s name or likeness in the manner
                                contemplated by the Service and these Terms of Service, and each such person has
                        ...
                        <ul>
                            <li>Be a recruiter, including attorneys that are engaged in the businesses of staffing
                                employees, or otherwise a third party to the retaining or hiring of attorneys unless
                                expressly permitted by Legably.
                            </li>
                            <li>Register and explore the software service for the purpose of reproducing, replicating,
                                or otherwise copying the software service and business model.
                            </li>
                            ...
                            <li>Upload, post, host or transmit unsolicited e-mail, SMS, Instant Messenger, Twitter or
                                other &quot;spam&quot; messages.
                            </li>
                            <li>Transmit worms or viruses or any other code of a destructive nature.</li>
                            <li>Use Legably to contact any other users outside of seeking or responding to a particular
                                job posting, unless otherwise permitted.
                            </li>
                            <li>Reproduce, duplicate, copy, sell, resell or exploit any portion of the Service, use of
                                the Service, or access to the Service without the express written permission by Legably.
                            </li>
                            <li>Use this service for any illegal or unauthorized purpose.</li>
                        </ul>
                        <br/>
                        Legably retains the right to pursue legal action and damages for any violations of any of these
                        restricted uses.<br/><br/>
                        Legably retains the right to refuse, suspend or terminate service to any user, for any time and
                        for any reason.<br/><br/>
                        <h1>The Relationship Between Attorneys and Legably</h1>
                        When attorneys create engagements through the Service, they are creating a contract for
                        professional services between each other. Legably does not have any responsibility to provide
                        the agreed services or enforce an attorney’s provision of those services.<br/><br/>
                        ...
                        circumstances:<br/><br/>
                        <ul>
                            <li>Legably will release the entire Attorney Fee to the attorney providing the service (the
                                “Providing Attorney”) and the Legably Service Fee to Legably if:
                                <ul>
                                    <li>The Receiving Attorney indicates, through the Service, that the agreed-to
                                        service has been completed by the Providing Attorney;
                                    </li>
                                    <li>Legably receives joint written instructions from both the Receiving Attorney and
                                        the Providing Attorney to release the entire Attorney Fee to the Providing
                                        Attorney; or
                                    </li>
                                    <li>Legably receives an order from a court of competent jurisdiction specifying that
                                        the Providing Attorney is entitled to the Attorney Fee.
                                    </li>
                                </ul>
                            </li>
                            <li>Legably will release portions of the Attorney Fee to the Providing Attorney if:
                                <ul>
                                    <li>The Receiving Attorney indicates, through the Service, that the portion of the
                                        agreed-to service corresponding to that portion has been completed by the
                                        Providing Attorney;
                                    </li>
                                    <li>Legably receives joint written instructions from both the Receiving Attorney and
                                        the Providing Attorney to release that portion of the Attorney Fee to the
                                        Providing Attorney; or
                                    </li>
                                    <li>Legably receives an order from a court of competent jurisdiction specifying that
                                        the Providing Attorney is entitled to that portion of the Attorney Fee.
                                    </li>
                                </ul>
                            </li>
                            <li>Legably will release the entire Attorney Fee and the Legably Service Fee to the
                                Receiving Attorney if:
                                <ul>
                                    <li>Legably receives joint written instructions from both the Receiving Attorney and
                                        the Providing Attorney to release the entire Attorney Fee back to the Receiving
                                        Attorney; or
                                    </li>
                                    <li>Legably receives an order from a court of competent jurisdiction specifying that
                                        the Receiving Attorney is entitled to return of the Attorney Fee.
                                    </li>
                                </ul>
                            </li>
                        </ul>
                        <br/>
                        For purposes of clarification, the Legably Service Fee is the consideration that Legably
                        receives for providing the Service. Legably will not, however, be entitled to the Legably
                        Service Fee until the Receiving Attorney (or a court of competent jurisdiction) indicates that
                        the Providing Attorney has performed all agreed-to services.<br/><br/>
                        Legably takes no responsibility for resolving disputes between Receiving Attorneys and Providing
                        Attorneys and will not intervene in any such disputes. You specifically agree to indemnify
                        Legably against any reasonably legal fees incurred in connection with any dispute between
                        yourself and another attorney.<br/><br/>
                        <h1>Payments:</h1>
                        Legably currently uses secure third-party payment processors to facilitate the payment of fees
                        by and to users. Our third-party payment processors accept payments through methods detailed on
                        the applicable payment screen, which may include, but not be limited to, Automated Clearing
                        House (ACH), various credit cards and PayPal. Information that you supply to our payment
                        processors is not stored by us or within our control, and is subject to each of our third-party
                        payment processors’ own privacy policies and terms and conditions. Third-party payment
                        processors may charge a fee to process payments and Legably is not responsible for any fees
                        charged by them. Third-party payment processors may maintain dispute management policies and/or
                        services for users of their services. Legably does not provide such services, and does not
                        mediate disputes that may arise between users.<br/><br/>
                        ...
                        authorized by the copyright owner, its agent, or under the law; and<br/>
                        ...
                        notification and allegation of copyright infringement.<br/><br/>
                        The designated Copyright Agent for Company is: Daniel P. Reilly<br/><br/>
                        Address of Agent: Legably Inc., 2 Regency Plaza, Suite 410, Providence, RI 02903<br/><br/>
                        ...
                        located at http://www.legably.com/privacy and incorporation into these Terms of Service by
                        ...
                        secure, or error-free basis, or will be accurate, reliable, free of viruses or other harmful
                        code,
                        ...
                        Any legal suit, action or proceeding arising out of, or related to, your use of the Service
                        shall
