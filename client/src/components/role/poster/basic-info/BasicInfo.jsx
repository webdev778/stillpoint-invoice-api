    ...
    render() {
        ...
        return (
            <Role step="basic_info" role="poster" profileStatus={this.state.completeStatus}>
                <div className="visible-xs mobile-page-heading">Basic Information<span
                    onClick={() => utils.changeUrl(constant['ROUTES_PATH']['POSTER_THANK_YOU'])}
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div
                                        ...
                                        <input onChange={this.handleUserInput} name="last_name"
                                               ...
                                               value={this.state.formVal.last_name} id="lname" className="form-control"
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div
                                        ...
                                        <input onBlur={this.handleInputOnBlur} type="text" name="city"
                                               value={this.state.formVal.city} id="city" onChange={this.handleUserInput}
                        ...
                        <div className="additional-info-card card">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input onChange={this.handleUserInput} onBlur={this.handleInputOnBlur}
                                               type="text" name="firm_name" value={this.state.formVal.firm_name}
                                               id="fname" className="form-control" placeholder="Firm Name"/>
                                    </div>
                                ...
                                <div className="col-sm-6">
                                    <div className="form-group">
                                        ...
                                        <input onChange={this.handleUserInput} name="title"
                                               onBlur={this.handleInputOnBlur} type="text"
                                               value={this.state.formVal.title} id="lname" className="form-control"
                                               placeholder="Title"/>
                                    </div>
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    ...
                                    <div className="form-group">
                                        <label htmlFor="" className="control-label">INTERESTED IN HIRING (NOW OR IN THE
                                            FUTURE)</label>
                                        <Select
                                            multi
                                            closeOnSelect={false}
                                ...
                                <div className="col-sm-6">
                                    ...
                                    <div
                                        className={this.state.formErrors.website_url !== '' ? 'form-group global-error' : 'form-group'}>
                                        <label htmlFor="website_url" className="control-label">Website</label>
                                        <input onChange={this.handleUserInput} name="website_url"
                                               onBlur={this.handleInputOnBlur} type="text"
                                               value={this.state.formVal.website_url} className="form-control"
                                               placeholder="Website"/>
                                        <p>
                                            <span>{this.state.formErrors.website_url !== '' ? this.state.formErrors.website_url : ''}</span>
                                        </p>
