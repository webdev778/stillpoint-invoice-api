            ...
            <div className="bg-white">
                ...
                <div className="content-wrapper container contact-panel">
                    ...
                    <div className="contact-section">
                        ...
                        <p>We want to hear from you. If you have questions, suggestions, or comments about Legably,
                            please complete the following form and we’ll get back to you as soon as possible.</p>
                        ...
                        <form className="contact-us-card card">
                            ...
                            <div className="row">
                                <div className="col-sm-6">
                                    <div
                                        className={this.state.formErrors.subject !== '' ? 'form-group global-error' : 'form-group'}>
                                        <label className="control-label">Subject*</label>
                                        <input name="subject" className="form-control" placeholder="Subject" type="text"
                                               value={this.state.subject} onBlur={this.handleInputOnBlur}
                                               onChange={this.handleUserInput}/>
                                        <p>
                                            <span>{this.state.formErrors.subject !== '' ? this.state.formErrors.subject : ''}</span>
                                        </p>
                                    </div>
                                </div>
                                <div className="col-sm-6">
                                    <div
                                        ...
                                        <input name="email" id="email" className="form-control" placeholder="Email"
                                               type="text" value={this.state.email} onBlur={this.handleInputOnBlur}
                                               onChange={this.handleUserInput}/>
                                        <p>
                                            <span>{this.state.formErrors.email !== '' ? this.state.formErrors.email : ''}</span>
                                        </p>
                                    </div>
                                </div>
                            </div>
                            <div
                                className={this.state.formErrors.message !== '' ? 'form-group global-error' : 'form-group'}>
                                <label className="control-label">Your Message*</label>
                                <textarea name="message" className="form-control" placeholder="Your Message"
                                          value={this.state.message} onBlur={this.handleInputOnBlur}
                                          onChange={this.handleUserInput}></textarea>
                                <p>
                                    <span>{this.state.formErrors.message !== '' ? this.state.formErrors.message : ''}</span>
                                </p>
                            </div>
                            <div className="row">
                                <div className="captcha-panel">
                                    <div
                                        className={this.state.formErrors.recapcthaValidErr !== '' ? 'pl-15 captcha-sub global-error' : "captcha-sub pl-15"}>
                                    ...
                                    <div className="pull-right">
                                        <button type="button" onClick={this._handleClick}
                                                className={this.state.disableButton ? "btn pull-right disabled-btn" : "btn pull-right"}
                            ...
                            <div className="row">
                                <div className="contact-text">Contact Us at <a className="contact-link"
                                                                               href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a> anytime
