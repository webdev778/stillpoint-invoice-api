        ...
        return (
            <div className="submit-deliverable-modal">
                ...
                <div className="modal-body m-0">
                    ...
                    {this.isSeeker() ?
                        <div
                            className={this.state.fileError === '' ? 'upload-file mt-10' : 'upload-file mt-10 global-error'}>
                            <DragDropFile handler={this.handler} title="Attach File"
                                          desc="Attach a file, timesheet, or invoice by clicking and selecting the specific file OR dragging and dropping the specific file into this area.'break'Note: Only one file can be attached, use Zip compression for multiple files."/>
                            {
                        ...
                        jobData.paymentDetails.filename ?
                            <div className="mt-10">
                                ...
                                <h4 className="text-left">
                                    Once you have reviewed it, please return to this dialog to Approve or Reject the
                                    deliverable.
                                </h4>
                            </div>
                            :
                ...
                <div className="modal-footer">
                    ...
                    <button className="btn-primary btn pull-right"
                            onClick={() => this.onYesBtnClick()}>{this.popupObj.yesBtnText}</button>
                    {this.isSeeker() ?
                        null
                        :
                        <button className="btn-negative btn pull-right"
                                onClick={() => this.onYesBtnClick(constant['DELIVERABLE_STATUS']['DECLINED'])}>Reject</button>
                    }
                    <span className="clearfix"></span>
                </div>
            </div>
