          ...
          :
            (
              <div className="status-content mt-45">
                ...
                <p>The hiring manager for this position is interested in discussing the role with you.</p>
                    ...
                    <div className="btns text-right">
                      {
                        highestStep > constant['JOB_STEPS']['INTERVIEWING'] ?
                          null
                        :
                          <button type="button" className={withdrawBtnSeeker} onClick={this.onWithdrawBtnClick.bind(this, jobId, (constant['JOB_STEPS']['INTERVIEWING'] * -1), null, constant['ROLE']['SEEKER'])}>
                      ...
                      }
                      {
                        highestStep === constant['JOB_STEPS']['J_COMPLETE'] ?
                          null
                        :
                          <button className="btn btn-primary pull-right" onClick={this.onSendMsgBtnClick.bind(this, null)}>
                            Send Message
                          </button>
                      }
                    </div>
