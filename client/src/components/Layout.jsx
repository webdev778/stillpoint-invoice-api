        ...
        return (
            ...
            <head>
                ...
                <meta name="Description"
                      content={constant['SEO_META_INFO']['DESC'][this.props.location.pathname] || ''}/>
            ...
            {
                this.state.showHeader ? <LegablyHeader headerKey={this.state.headerKey} session={this.state.isSession}
                                                       homepage={this.state.isHomePage}
                                                       currentPage={this.state.currentPage}
                                                       logoImage={this.state.logoImage}
                                                       isTransHeader={this.state.isTransHeader}/> : null
            }
