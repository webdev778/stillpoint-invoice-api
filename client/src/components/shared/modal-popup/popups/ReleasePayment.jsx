        ...
        return (
            <div className="send-msg-modal release-payment-modal">
                ...
                <div className="modal-body m-0">
                    <p>By clicking the Release Payment button below, you agree to instruct Stripe Connect to transfer
                        funds currently held in stripe to the seller and complete this milestone.</p>
                ...
                <div className="modal-footer">
                    ...
                    <button className="yellow-btn btn pull-right" onClick={() => this.onYesBtnClick()}>Release Payment
                    </button>
                </div>
            </div>
        )
