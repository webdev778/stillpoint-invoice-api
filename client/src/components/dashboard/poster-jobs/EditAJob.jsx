                ...
                <section className="job-details-wrapper">
                    <div className="section-head">
                        <ol className="breadcrumb">
                            ...
                            <p>
                                <Link to={myPostedJobsPath}>My Jobs</Link><i className="fa fa-angle-right mr-15 ml-15"
                                                                             aria-hidden="true"></i>
                                <Link to={myPostedJobsPath + '/' + this.jobId}>Job Detail</Link><i
                                className="fa fa-angle-right mr-15 ml-15" aria-hidden="true"></i> Edit Job
                            </p>
                        </ol>
                    </div>
