...
export default class Applied extends React.Component {
    ...
    getDate() {
        ...
        return (
            <h6 className="">You applied for this job
                on {momentDate.format(constant['DATE_FORMAT'])} at {momentDate.format('LT')}.</h6>
        )
    }
                    ...
                    <div className="status-content mt-45">
                        ...
                        }
                        {
                            this.props.highestStep === (constant['JOB_STEPS']['APPLIED'] * -1) ?
                                ...
                                :
                                <p>We’ll let you know when the hiring manager for this posting has reviewed your
                                    application and decided how to proceed!</p>
                        }
                    </div>
                    :
                    <div className="status-content mt-45">
                                                    ...
                                                    </p>
                                                    {
                                                        item.isDeclined ?
                                                            <div className="buttons text-right">
                                                                ...
                                                                <button type="button" className="btn btn-grey-disabled"
                                                                        disabled>
                                                            ...
                                                            item.freeze_activity ?
                                                                <div className="buttons text-right">
                                                                    ...
                                                                    <button type="button"
                                                                            className="btn btn-primary seized-btn"
                                                                            onClick={this.onDeclineBtnClick.bind(this, jobId, (constant['JOB_STEPS']['APPLIED'] * -1), item._id, index)}>
                                                                        decline
                                                                    </button>
                                                                    <button type="button"
                                                                            className="btn btn-primary seized-btn"
                                                                            onClick={this.updateCandidateJobStatus.bind(this, jobId, constant['JOB_STEPS']['INTERVIEWING'], item._id, index)}>
                                                                        Interview
                                                                    </button>
                                                                </div>
                                                                :
