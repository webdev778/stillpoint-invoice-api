...
const logger = (type, msg, value = null) => {
    ...
    switch (type) {
        case 'error':
            configObj['SHOW_CLIENT_ERROR'] && console.error(msg, (value === null ? '' : value));
            break;
        case 'warn':
            configObj['SHOW_CLIENT_WARN'] && console.warn(msg, (value === null ? '' : value));
            break;
        case 'log':
            configObj['SHOW_CLIENT_LOG'] && console.log(msg, (value === null ? '' : value));
            break;
    }
}
