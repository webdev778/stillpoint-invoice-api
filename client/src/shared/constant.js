...
module.exports = {
  ...
  'POPUP_MSG': {
    ...
    'LEAVE_ROLE': 'The information you have entered on this page may not have been saved. Are you sure you want to leave?',
    'JOB_POST_SUCCESS': 'Your job has been posted successfully.\nDo you want to create a new job?',
    'JOB_SAVE_SUCCESS': 'Your job has been saved successfully.\nDo you want to create a new job?',
    'JOB_UPDATE_SUCCESS': 'Your job has been updated successfully.',
    'INCOMPLETE_SEEKER_PROFILE': 'You must complete the "I Want To Find A Job" section of your profile before you can access this option.',
    'INCOMPLETE_POST_PROFILE': 'You must complete the "I Want To Post A Job" section of your profile before you can access this option.',
    'DECLINE_CANDIDATE': 'decline this candidate?',
    'CANDIDATE_IN_NEGOTIATING_TERM': 'You can negotiate terms with only one candidate at a time.',
    'WITHDRAW_BY_POSTER': 'remove this candidate from consideration for this job?',
    'WITHDRAW_BY_SEEKER': 'remove yourself from consideration for this job?',
    'REMAINING_AMOUNT_ERROR': 'Remainder To Be Allocated amount must be zero before you can Submit Terms.',
    'SUBMIT_TERMS_SUCCESS': 'Your job terms have been submitted to the candidate.',
    'SUBMIT_TERMS_FRAGMENT': '\nOnce a candidate accepts your terms you will be asked to create a Stripe account on the Start Pending screen so you can transfer funds and start work on the job.\nIf you have any additional questions please contact the Legably support team at <a href="mailto:' + SUPPORT_ID + '">support@legably.com</a>.',
    'SEND_MSG_SUCCESS': 'Message sent successfully.',
    'ACCEPT_TERMS': 'accept the proposed terms?',
    'ACCEPT_TERMS_SUCCESS': 'You have accepted the job terms proposed by the hiring manager.',
    ...
    'CREATE_STRIPE_ACCOUNT': 'You have not created your stripe account yet. Please do so before editing your W-9 information.',
    'W_NINE_SUCCESS': 'W-9 Tax Information saved successfully.',
    'SEQUENTIAL_ORDER_DUE_DATE': 'Before submitting terms to the candidate you must correct the following items:\n\n<ul><li>Every milestone must have a due date assigned to it and should not be less than the current date.</li><li>Each milestone\'s due date must be greater than the previous milestone\'s due date.</li></ul>',
    'RELEASE_PAYMENT_SUCCESS': 'Payment has been released successfully.',
    'TRANSFER_FUNDS': 'Are you sure you want to tranfer {amount} to Legably to start work on this job?'
  },
  'MESSAGES': {
    'DECLINED_BY_CANDIDATE': 'You have decided not to proceed with your application.',
    'DECLINED_BY_HIRING_MANAGER': 'The hiring manager has decided not to proceed with your application.'
  },
  'ROUTES_PATH': ROUTES_PATH,
  'SEO_META_INFO': {
    'TITLE': {
      [ROUTES_PATH['HOME']]: 'Hire the Best Attorney | Find the Best Legal Job | Free to Post & Search | Legably',
      [ROUTES_PATH['SIGN_UP']]: 'Sign-Up | Legably',
      [ROUTES_PATH['SIGN_IN']]: 'Sign-In | Legably',
      [ROUTES_PATH['COMPANY_OVERVIEW']]: 'Company Overview | About Us | Legably',
      ...
      [ROUTES_PATH['SEEKER_BASIC_INFO']]: 'Attorney Profile | Basic Info | Legably',
      [ROUTES_PATH['SEEKER_EXEPERIENCE']]:  'Attorney Profile | Experience | Legably',
      ...
      [ROUTES_PATH['POSTER_BASIC_INFO']]: 'Post a Job | Basic Information | Legably',
      [ROUTES_PATH['POSTER_THANK_YOU']]: 'Post a Job | Thank You | Legably'
    },
    'DESC': {
      [ROUTES_PATH['HOME']]: 'Legably is a modern online platform connecting attorneys seeking jobs with hiring attorneys and law firms in need of their services. Free to post legal jobs and search for work.',
      ...
      [ROUTES_PATH['FAQ']]: 'Frequently asked questions about the Legably online legal staffing platform.  ',
      [ROUTES_PATH['SUPPORT_CENTER']]: 'Contact the Legably team with questions, suggestions, or for technical support.'
    }
  },
  'ROLE': {
    'POSTER': 'poster',
