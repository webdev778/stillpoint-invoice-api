            ...
            if (err) {
                ...
                if (utils.isResSuccess(response)) {
                    ...
                    for (let jobTypeObj of data['job_types']) {
                        jobTypes.push(<option key={jobTypeObj['_id']}
                                              value={jobTypeObj['name']}>{jobTypeObj['name']}</option>);
                    }
                    that.setState({job_type_dropdown: jobTypes});

                    for (let paymentTypeObj of data['payment_types']) {
                        paymentTypes.push(<option key={paymentTypeObj['_id']}
                                                  value={paymentTypeObj['name']}>{paymentTypeObj['name']}</option>);
                    }
                    ...
                    for (let statesObj of data['states']) {
                        states.push(<option key={statesObj['_id']}
                                            value={statesObj['_id']}>{statesObj['name']}</option>);
                    }
                    that.setState({state_dropdown: states});

                    for (let workLocationsObj of data['work_locations']) {
                        workLocations.push(<option key={workLocationsObj['_id']}
                                                   value={workLocationsObj['_id']}>{workLocationsObj['name']}</option>);
                    }
                    ...
                    <div className="job-posting-card card">
                        <div className="row">
                            <div className="col-sm-6">
                                <div
                                    className={this.state.formError.jobType ? 'form-group global-error' : 'form-group'}>
                                    <label className="control-label">Job Type*</label>
                                    <select name="jobType" className="form-control" value={job.jobType}
                            ...
                            <div className="col-sm-6">
                                <div
                                    className={this.state.formError.paymentType ? 'form-group global-error' : 'form-group'}>
                                    <label className="control-label">Payment Type*</label>
                                    <select name="paymentType" className="form-control" value={job.paymentType}
                                    ...
                                    {this.state.formError.paymentType ?
                                        <p><span> Please select payment type </span></p> : ''}
                                </div>
                            </div>
                        </div>
                        <div className={this.state.formError.jobHeadline ? 'form-group global-error' : 'form-group'}>
                            ...
                            <input name="jobHeadline" className="form-control" placeholder="Job Headline" type="text"
                                   maxLength="150" value={job.jobHeadline}
                        ...
                        <div className="row">
                            <div
                                className={(job.showOthers == 'true' || job.showOthers == true) ? "col-sm-4" : "col-sm-6"}>
                                <div
                                    className={this.state.formError.practiceArea ? 'form-group global-error' : 'form-group'}>
                                    ...
                                    {this.state.formError.practiceArea ?
                                        <p><span> Please select practice area </span></p> : ''}
                                </div>
                            </div>
                            <div
                                className={(job.showOthers == 'true' || job.showOthers == true) ? "col-sm-4" : "col-sm-6"}>
                                <div
                                    className={this.state.formError.skillsNeeded ? 'form-group global-error' : 'form-group'}>
                                    ...
                                    {this.state.formError.skillsNeeded ?
                                        <p><span> Please select skills needed </span></p> : ''}
                                </div>
                            </div>
                            <div className="col-sm-4">
                                <div
                                    className={(job.showOthers == 'true' || job.showOthers == true) ? 'form-group' : 'form-group d-none'}>
                                    <label className="control-label">Other</label>
                                    <input value={job.others} onBlur={(e) => this.handleOnBlur(e, 'others')}
                                           onChange={(e) => this.changeInput(e, 'others')} name="others"
                                           className="form-control" placeholder="Other skills needed" type="text"/>
                                </div>
                            </div>
                        </div>
                        <div className={this.state.formError.jobDescription ? 'form-group global-error' : 'form-group'}>
                            ...
                            <textarea name="jobDescription" className="form-control" maxLength="2000"
                                      placeholder="Type your description here" value={job.jobDescription}
                                      onChange={(e) => this.changeInput(e, 'jobDescription')}
                                      onBlur={(e) => this.handleOnBlur(e, 'jobDescription')}></textarea>
                            {this.state.formError.jobDescription ?
                                <p><span> Please enter job description </span></p> : ''}
                        </div>
                        <div className="row">
                            <div className="col-sm-4">
                                <div className={this.state.formError.city ? 'form-group global-error' : 'form-group'}>
                                    <label className="control-label">City*</label>
                                    <input name="city" className="form-control" placeholder="City" type="text"
                                           value={job.city} onChange={(e) => this.changeInput(e, 'city')}
                                           onBlur={(e) => this.handleOnBlur(e, 'city')}/>
                            ...
                            <div className="col-sm-4">
                                <div className={this.state.formError.state ? 'form-group global-error' : 'form-group'}>
                                    ...
                                    <select name="state" className="form-control" value={job.state}
                            ...
                            <div className="col-sm-4">
                                <div
                                    className={this.state.formError.zipCode ? 'form-group global-error' : 'form-group'}>
                                    <label className="control-label">Zip Code*</label>
                                    <input name="zipCode" className="form-control" placeholder="Zip Code" type="text"
                                           value={job.zipCode}
                                           onChange={(e) => this.validateLength(e, 'zipCode', 99999)}
                                           onBlur={(e) => this.handleOnBlur(e, 'zipCode')}/>
                        ...
                        <div className="row">
                            <div className="col-sm-6">
                                <div
                                    className={this.state.formError.setting_id ? 'form-group global-error' : 'form-group'}>
                                    <label className="control-label">Location*</label>
                                    <select name="setting_id" className="form-control" value={job.setting_id}
                                    ...
                                    {this.state.formError.setting_id ?
                                        <p><span> Please select location </span></p> : ''}
                                </div>
                            </div>
                            <div className="col-sm-6">
                        ...
                        <div className="posting-two-cols">
                            <div className='form-group'>
                                ...
                                <div
                                    className={this.state.formError.duration ? 'global-error inline-to-block' : 'inline-to-block'}>
                                    <input name="duration" className="form-control custom-num" placeholder="00"
                                           type="text" value={job.duration}
                                           onChange={(e) => this.validateLength(e, 'duration', 999)}
                                           onBlur={(e) => this.handleOnBlur(e, 'duration')}/>
                                    {this.state.formError.duration ?
                                        <p><span> {this.state.formError.duration} </span></p> : ''}
                                </div>
                                <ul className="tabbed-radio-btns three-tabs">
                                    <li>
                                        <input type="radio" name="d-w-m"
                                               checked={job.durationPeriod == utils.ENUM.DURATION_PERIOD.DAYS ? 1 : 0}
                                               value={utils.ENUM.DURATION_PERIOD.DAYS}
                                               onClick={(e) => this.changeInput(e, 'durationPeriod')}/>
                                        <span>Days</span>
                                    </li>
                                    <li>
                                        <input type="radio" name="d-w-m" value={utils.ENUM.DURATION_PERIOD.WEEKS}
                                               checked={job.durationPeriod == utils.ENUM.DURATION_PERIOD.WEEKS ? 1 : 0}
                                               onClick={(e) => this.changeInput(e, 'durationPeriod')}/>
                                        <span>Weeks</span>
                                    </li>
                                    <li>
                                        <input type="radio" name="d-w-m" value={utils.ENUM.DURATION_PERIOD.MONTHS}
                                               checked={job.durationPeriod == utils.ENUM.DURATION_PERIOD.MONTHS ? 1 : 0}
                                               onClick={(e) => this.changeInput(e, 'durationPeriod')}/>
                                        <span>Months</span>
                                    </li>
                                </ul>
                        ...
                        <div className="posting-two-cols">
                            <div className='form-group'>
                                ...
                                <div
                                    className={this.state.formError.rate ? 'global-error inline-to-block' : 'inline-to-block'}>
                                    <input className="form-control amount-dollar-bg text-left custom-num"
                                           placeholder="Rate" type="text" value={job.rate}
                                           onChange={(e) => this.validateAndCalculateAmount(e, 'rate', 999999)}
                                ...
                                <ul className="tabbed-radio-btns">
                                    <li>
                                        <input type="radio" name="h-f"
                                               checked={job.rateType == utils.ENUM.RATE_TYPE.HOURLY ? 1 : 0}
                                               value={utils.ENUM.RATE_TYPE.HOURLY}
                                               onClick={(e) => this.onChangeHoursType(e, 'rateType')}/>
                                        <span>Hourly</span>
                                    </li>
                                    <li>
                                        <input type="radio" name="h-f"
                                               checked={job.rateType == utils.ENUM.RATE_TYPE.FIXED ? 1 : 0}
                                               value={utils.ENUM.RATE_TYPE.FIXED}
                                               onClick={(e) => this.onChangeHoursType(e, 'rateType')}/>
                                        <span>Fixed</span>
                                    </li>
                                </ul>
                        ...
                        <div className="posting-two-cols hours-col">
                            <div className='form-group'>
                                ...
                                <div
                                    className={this.state.formError.hours && job.rateType != utils.ENUM.RATE_TYPE.FIXED ? 'global-error inline-to-block' : 'inline-to-block'}>
                                    <input className="form-control custom-num" placeholder="00" type="text"
                                           value={job.hours}
                                           onChange={(e) => this.validateAndCalculateAmount(e, 'hours', 999)}
                                           onBlur={(e) => this.handleOnBlur(e, 'hours')}
                                           disabled={this.state.diableHours}/>
                                    {this.state.formError.hours ?
                                        <p><span> {this.state.formError.hours} </span></p> : ''}
                                </div>
                                <div className="pt-ft-w-m">
                                    <ul className="tabbed-radio-btns">
                                        {this.state.employment_type_dropdown.map((hoursType, index) =>
                                            <li key={index}>
                                                <input type="radio" name="pt-ft"
                                                       checked={hoursType.value == job.hoursType ? 1 : 0}
                                                       value={hoursType.value}
                        ...
                        <div className="estimated-section">
                            ...
                            <div className="estimated-amount-section">
                                ...
                                <p>Based on the information you have provided, the estimated amount payable to your
                                    selected candidate is indicated below.</p>
                                <div className="row">
                                    <div className="col-sm-4">
                                        <div
                                            className={this.state.formError.subTotal ? 'form-group global-error' : 'form-group'}>
                                            <label className="control-label">AMOUNT PAYABLE</label>
                                            <input className="form-control amount-dollar-bg" placeholder="Total"
                                                   type="text" value={job.subTotal} disabled="true"/>
                                            {this.state.formError.subTotal ?
                                                <p><span> {this.state.formError.subTotal} </span></p> : ''}
                                        </div>
                                    </div>
                                </div>
                                <div className="separator"></div>
                            ...
                            <div className="estimated-schedule-section">
                                ...
                                <p>The estimated payment and deliverable schedule allows you to disperse the estimated
                                    amount payable to your selected candidate over the course of your project or task
                                    based upon the completion of specific deliverables. If there is only one
                                    deliverable, simply allocate the estimated amount payable to your selected candidate
                                    to that single item. </p>
                                ...
                                {job.paymentDetails.map((paymentDetail, index) =>
                                    <ul className="payment-details row" key={index}>
                                        <li className={paymentDetail.errorMessage ? 'global-error col-sm-4' : 'col-sm-4'}>
                                            ...
                                            <input className="amount-dollar-bg custom-num" type="text"
                                                   placeholder="Payment" value={paymentDetail.rate}
                                        ...
                                        <li className="col-sm-4">
                                            ...
                                            <input type="text" className="form-control"
                                                   placeholder="Deliverable Description" value={paymentDetail.delivery}
                                                   onChange={(e) => this.setPaymentDetails(e, 'delivery', index)}/>
                                        </li>
                                        <li className='col-sm-4'>
                                            ...
                                            {paymentDetail.dueDate ?
                                                <span className="clear"
                                                      onClick={(e) => this.handleDueDate('', index)}></span>
                                                :
                                                null
                                            }
                                        </li>
                                ...
                                <ul className="remaining-detail">
                                    <li>
                                        ...
                                        <input type="text" className="form-control amount-dollar-bg"
                                               placeholder="Remaining" value={job.remainingAmount} disabled="true"/>
                                    </li>
                                </ul>
                                <div className="separator"></div>
                            </div>
                                ...
                                {!(job.jobType == '1099' && job.paymentType == 'Hourly Rate/Fixed Fee') ? (
                                    <div className="estimated-total-cost">
                                        ...
                                        <p>The estimated total cost of this engagement is indicated below. Please note
                                            that this amount is subject to change pending final agreed upon terms
                                            negotiated between you and the candidate. Once you have agreed to terms with
                                            your candidate and are ready to move forward, the actual total cost will be
                                            due and placed in escrow, payable to your candidate per the final agreed
                                            upon payment and deliverable schedule.</p>
                                        <p>
                                            <span
                                                className="pull-left">Estimated amount payable to selected candidate:</span>
                                            <span
                                                className="pull-right">{isNaN((parseFloat(job.subTotal)).toFixed(2)) ? "$00.00" : '$' + job.subTotal}</span>
                                            <span className="clearfix"></span>
                                        </p>
                                        <p>
                                            <span className="pull-left">Estimated Legably service charge:</span>
                                            <span
                                                className="pull-right">{isNaN((parseFloat(this.state.legablyChargesForFixed)).toFixed(2)) ? '$0.00' : '$' + this.state.legablyChargesForFixed}</span>
                                            <span className="clearfix"></span>
                                        </p>
                                        <p className="clearfix grand-total">
                                            <span className="pull-left">Estimated total cost</span>
                                            <span
                                                className="pull-right">{isNaN((parseFloat(job.total)).toFixed(2)) ? '$00.00' : '$' + parseFloat(job.total).toFixed(2)}</span>
                                            <span className="clearfix"></span>
                                        </p>
                                    </div>
                                ) : (
                                    <p>By posting this job you agree to pay an attorney for the work outlined above
                                        based either on the hourly rate or the fixed fee that the you both agree to on
                                        the Negotiated Terms screen. You also agree to pay the Legably service charge at
                                        the same time of payment to the attorney completing the work.</p>
                                )
                                }
                            </div>
                        </div>
                        ...
                        this.props.isEditJobPage ?
                            <div className="nxt-prev-btns">
                                <button type="submit" name="updateJob"
                                        ...
                                        onClick={(e) => this.updateJob(e, job.status)}>Update Job
                                </button>
                                <span className="clear-fix"></span>
                            </div>
                            :
                            <div className="nxt-prev-btns">
                                <button type="submit" name="postJob"
                                        className="d-block btn-primary btn pull-right ml-10"
                                        onClick={(e) => this.postOrSaveJob(e, constant['STATUS']['ACTIVE'])}>Post Job
                                </button>
                                <button type="submit" name="saveJob" className="d-block btn-primary btn pull-right"
                                        onClick={(e) => this.postOrSaveJob(e, constant['STATUS']['INACTIVE'])}>Save Job
                                </button>
                                <span className="clear-fix"></span>
                            </div>
                    }
