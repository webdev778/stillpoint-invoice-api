            ...
            <div className="sign-up-page-wrapper">
                <section className="right-section sign-up-section pull-right">
                    <div className="white-logo-bg">
                        <img onClick={() => utils.goToHome()} src={constant['IMG_PATH'] + 'primaryHorizontalRgb@2x.jpg'}
                             alt="leably-white-logo" className="img-responsive mobile-on-logo" width="120" height="31"/>
                    </div>
                    <div className="form-wrapper">
                        ...
                        <form className="sign-up-form mb-30" onSubmit={this._handleClick}>
                            <div
                                ...
                                <input name="first_name" type="text" className="form-control" id="fname"
                            ...
                            <div
                                ...
                                <input type="text" className="form-control" name="last_name" id="lname"
                            ...
                            <div
                                ...
                                <input type="text" className="form-control email-id" name="email"
                                       ...
                                       onBlur={this.handleInputOnBlur} onChange={this.handleUserInput}/>
                                <p><span>{this.state.formErrors.email !== '' ? this.state.formErrors.email : ''}</span>
                                </p>
                            </div>
                            <div
                                className={this.state.formErrors.password !== '' ? 'form-group global-error' : 'form-group'}>
                                <label htmlFor="pwd">Password*</label>
                                <div className="pwd-wrapper">
                                    <input type="password" id="pwd" className="pswd form-control" name="password"
                                           placeholder="Password" value={this.state.password}
                                           onBlur={this.handleInputOnBlur} onChange={this.handleUserInput}/>
                                    <span onClick={this.showPassword} className="eye"><i
                                        className={this.state.showPass ? "fa fa-eye" : "fa fa-eye-slash"}></i></span>
                                </div>
                                <p>
                                    <span>{this.state.formErrors.password !== '' ? this.state.formErrors.password : ''}</span>
                                </p>
                            </div>
                            <div
                                className={this.state.formErrors.confirm_password !== '' ? 'form-group global-error' : 'form-group'}>
                                <label htmlFor="repwd">Retype Password* </label>
                                <div className="pwd-wrapper">
                                    <input type="password" className="pswd form-control" id="repwd"
                                           name="confirm_password" placeholder="Retype Password"
                                           value={this.state.confirm_password} onBlur={this.handleInputOnBlur}
                                           onChange={this.handleUserInput}/>
                                    <span onClick={this.showRePassword} className="eye"><i
                                        className={this.state.showRePass ? "fa fa-eye" : "fa fa-eye-slash"}></i></span>
                                </div>
                                <p>
                                    <span>{this.state.formErrors.confirm_password !== '' ? this.state.formErrors.confirm_password : ''}</span>
                                </p>
                            </div>
                            <div
                                className={this.state.formErrors.recapcthaValidErr !== '' ? 'form-group checkbox global-error responive-captcha' : 'form-group checkbox responive-captcha'}>
                                {this.state.sitekey ?
                                    <Recaptcha ref={e => recaptchaInstance = e} sitekey={this.state.sitekey}
                                               render="explicit" verifyCallback={this.verifyCallback}
                                               onloadCallback={this.resetCallback}/> : ''}
                                <p>
                                    <span>{this.state.formErrors.recapcthaValidErr !== '' ? this.state.formErrors.recapcthaValidErr : ''}</span>
                                </p>
                            </div>
                            <div
                                className={this.state.formErrors.termCond !== '' ? 'form-group checkbox global-error' : 'form-group checkbox'}>
                                <label className="pmd-checkbox">
                                    <input name="termCond" type="checkbox" checked={this.state.termCond}
                                           onChange={this.handleInputChange}/><span
                                    className="pmd-checkbox-label">&nbsp;</span>By clicking <q>Sign Up</q> I agree to
                                    Legably's Terms of Service
                                </label>
                                <p>
                                    <span>{this.state.formErrors.termCond !== '' ? this.state.formErrors.termCond : ''}</span>
                                </p>
                            </div>
                            <div className="btns">
                        ...
                        <div className="already-signed">Already have an account? <Link
                            to={constant['ROUTES_PATH']['SIGN_IN']}>Sign In</Link></div>
                    </div>
                </section>
