        ...
        return (
            <div className="send-msg-modal release-payment-modal">
                ...
                <div className="modal-body m-0">
                    <form>
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control amount-dollar-bg text-left custom-num" placeholder="Rate"
                                   type="text"
                        ...
                        {paymentDetails.rateType != utils.ENUM.RATE_TYPE.FIXED &&
                        <div
                            className={this.state.formError.hours && paymentDetails.rateType != utils.ENUM.RATE_TYPE.FIXED ? 'form-group global-error' : 'form-group'}>
                            <label className="control-label">HOURS OF WORK*</label>
                            <input className="form-control custom-num" placeholder="00" type="text"
                                   value={paymentDetails.hours}
                        ...
                        <div className={this.state.formError.subTotal ? 'form-group global-error' : 'form-group'}>
                            ...
                            <input className="form-control amount-dollar-bg" placeholder="Amount Payable" type="text"
                                   value={paymentDetails.subTotal} disabled="true"/>
                        ...
                        <div className="form-group">
                            ...
                            <input className="form-control amount-dollar-bg" placeholder="Service Charge" type="text"
                                   value={parseFloat(parseFloat(paymentDetails.subTotal * paymentDetails.currentRate / 100).toFixed(2))}
                                   disabled="true"/>
                        </div>

                        <div className="form-group">
                            <label className="control-label">TOTAL COST</label>
                            <input className="form-control amount-dollar-bg" placeholder="Total Cost" type="text"
                                   value={paymentDetails.total} disabled="true"/>
                        </div>
                ...
                <div className="modal-footer">
                    ...
                    <button className="yellow-btn btn pull-right" onClick={() => this.onYesBtnClick()}>Transfer Funds
                    </button>
                </div>
            </div>
        )
