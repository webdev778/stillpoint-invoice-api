                    ...
                    { this.state.role !== 'admin' ?
                        eitherOneProfileCompleted ?
                          <div className="navbar-mid-wraper col-xs-7 col-sm-6 pull-left p-0">
                            <button className="yellow-btn m-0" type="button" onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}> Post a Job </button>
                            <button className="yellow-btn ml-10" type="button" onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}> Find a Job </button>
                          </div>
                        :
                          null
                      :
                  ...
                  <div className="row m-0">
                    {
                      !this.props.session ?
                        <div className="navbar-mid-wraper col-xs-7 col-sm-6 pull-left p-0">
                          <button className={"mr-10 " + transButton} type="button" onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])}> Post a Job </button>
                          <button className={"" + transButton} type="button" onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])}> Find a Job </button>
                        </div>
                      :
                        null
                    }
            ...
            !isHomePage ?
              !this.props.session ?
                <div className="navbar-mid-wraper">
                  <button onClick={() => this.moveToPostOrFindJobSection(this.routesPath['POST_JOB'])} className="yellow-btn" type="button"> Post a Job </button>
                  <button onClick={() => this.moveToPostOrFindJobSection(this.routesPath['JOB_SEARCH'])} className="yellow-btn ml-10" type="button"> Find a Job </button>
                </div>
              :
                eitherOneProfileCompleted ?
                  <div className="navbar-mid-wraper">
