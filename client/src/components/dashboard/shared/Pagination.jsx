    ...
    render() {
        ...
        return (
            <div className="btn-group pagination-btns">
                <button type="button" className="btn" onClick={this.handlePrevClick}
                        disabled={activePage === 1}>&lt;</button>
                <button type="button" className="btn fake-button">Page {activePage} of {totalPageCount}</button>
                <button type="button" className="btn" onClick={this.handleNextClick}
                        disabled={activePage === totalPageCount}>&gt;</button>
            </div>
        );
    }
}
