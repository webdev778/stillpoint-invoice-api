    ...
    render() {
        ...
        return (
            <div className="flex-to-block">
                    ...
                    <aside className="d-flex sidebar-wrapper pull-left">
                        ...
                        <nav id="sidebar" className="sidebar-fixed">
                            ...
                            <ul className="list-unstyled components">
                                <li onClick={() => this.moveToPage(routesPath['JOB_SEARCH'], 'seeker')}
                                    className={selectedPage.includes(routesPath['JOB_SEARCH']) ? 'active' : ''}>
                                    <a>
                ...
                */}
                                <li onClick={() => this.moveToPage(routesPath['MY_APPLIED_JOBS'], 'seeker')}
                                    className={selectedPage.includes(routesPath['MY_APPLIED_JOBS']) ? 'active' : ''}>
                                    <a>
                ...
                */}
                            ...
                            {/*Sidebar Links*/}
                            <ul className="list-unstyled components">
                                <li onClick={() => this.moveToPage(routesPath['MY_POSTED_JOBS'], 'poster')}
                                    className={(selectedPage.includes(routesPath['MY_POSTED_JOBS']) || (selectedPage.includes('profile') && !selectedPage.endsWith('attorney') && !selectedPage.endsWith('firm'))) ? 'active' : ''}>
                                    <a>
                                        <i className="fa fa-file-text-o" aria-hidden="true"></i>
                                        My Jobs</a>
                                </li>
                                <li onClick={() => this.moveToPage(routesPath['CANDIDATE_SEARCH'], 'poster')}
                                    className={(selectedPage.includes(routesPath['CANDIDATE_SEARCH']) || (selectedPage.includes('profile') && !selectedPage.endsWith('attorney') && !selectedPage.endsWith('firm'))) ? 'active' : ''}>
                                    <a href="#">
                                        <i className="fa fa-search" aria-hidden="true"></i>
                                        Candidate Search</a>
                                </li>
                ...
                <li>
                  ...
                  Payments</a>
                                ...
                                <li onClick={() => this.moveToPage(routesPath['POST_JOB'], 'poster')}
                                    className={selectedPage.includes('post-job') ? 'active' : ''}>
                                    <a>
