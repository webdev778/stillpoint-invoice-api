            ...
            this.state.emailVerified ?
                ...
                <div className="user-login-wrapper">
                    <section className="left-banner pull-left forgot-pwd-banner reset-link-banner">
                        <div>
                            <img onClick={() => utils.goToHome()} src={constant['IMG_PATH'] + 'logo-white@2x.png'}
                                 alt="leably-white-logo" className="img-responsive logo" width="180" height="47"/>
                        ...
                        <div className="reset-link-page-wrapper">
                            <section className="right-section reset-link-section pull-right">
                                <div className="white-logo-bg">
                                    <img src="/images/primaryHorizontalRgb@2x.jpg" alt="leably-white-logo"
                                         className="img-responsive mobile-on-logo" width="120" height="31"/>
                                </div>
                                <div className="form-wrapper">
                                    <h5>Invalid Link or Link has been expired</h5>
                                    <div className="btns">
                                        <button type="button" className="btn reset-link-btn"
                                                onClick={() => utils.changeUrl(constant['ROUTES_PATH']['SIGN_IN'])}>Continue
                                            to Sign In
                                        </button>
                                    </div>
                                </div>
