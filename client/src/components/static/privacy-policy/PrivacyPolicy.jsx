            ...
            <div className="bg-white">
                ...
                <div className="content-wrapper container privacy-policy">
                    ...
                    <div className="static-panel-div">
                        This privacy policy sets out how Legably uses and protects any information that you give
                        “[business name]” when you use this website.<br/><br/>
                        Legably is committed to ensuring that your privacy is protected. Should we ask you to provide
                        certain information by which you can be identified when using this website, then you can be
                        assured that it will only be used in accordance with this privacy statement.<br/><br/>
                        Legably may change this policy from time to time by updating this page. You should check this
                        page from time to time to ensure that you are happy with any changes. This policy is effective
                        from August 1, 2017.<br/><br/>
                        ...
                        <ul>
                            ...
                            <li>Payment information, including, but not limited to, credit card, bank account, ACH and
                                PayPal information;
                            </li>
                        ...
                        <ul>
                            ...
                            <li>Banking information is encrypted and transmitted via 2048-bit encryption for your
                                protection.
                            </li>
                        </ul>
                        <br/>
                        <h1>Sharing Your Information</h1>
                        Legably will not share any information collected on the site unless provided for under this
                        policy. Legably may provide personal information to Legably employees, contractors,
                        sub-contractors, professional advisors and other third parties as may be necessary. This may be
                        necessary for, among other reasons, providing product improvements and enhancing communication
                        between our users and Legably.<br/><br/>
                        Legably, from time-to-time, may engage in partnerships or other affiliate agreements with other
                        entities. Legably may share your information with these entities. Any partner or affiliate of
                        Legably shall be required to adhere to this Privacy Policy.<br/><br/>
                        <h1>Public Information</h1>
                        As a part of the profile creation process, Legably users create a profile and provide
                        information including, but not limited to, contact and firm information, career preferences and
                        past experience. Any other registered user of Legably can view this information. Legably
                        maintains no obligations as to your profile or any information provided to other registered
                        users of the site.<br/><br/>
                        <h1>Security</h1>
                        ...
                        procedures to safeguard and secure the information we collect online. This includes secure
                        2048-bit SSL encryption.<br/><br/>
                        ...
                        remembering information about your preferences.<br/><br/>
                        ...
                        or any information about you, other than the data you choose to share with us.<br/><br/>
                        ...
                        once you have used these links to leave our site, you should note that we do not have any
                        control over that other website. Therefore, we cannot be responsible for the protection and
                        ...
                        statement applicable to the website in question.<br/><br/>
                        ...
                        us that you wish this to happen.<br/><br/>
                        Legably users may review any personal information maintained by Legably by contacting us at <a
                        className="contact-link" href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a>.<br/><br/>
                        If you believe that any information we are holding on you is incorrect or incomplete, please
                        contact us at <a className="contact-link"
                                         href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a>. We will
                        promptly correct any information found to be incorrect.<br/><br/>
                        <h1>Contact Information</h1>
                        Please feel free to contact us via email at <a className="contact-link"
                                                                       href={"mailto:" + constant['SUPPORT_ID']}>support@legably.com</a> for
                        any information on Legably’s privacy policy and initiatives.
                    </div>
                </div>
