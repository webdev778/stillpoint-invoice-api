                    ...
                    <div className="row">
                        <div className="col-sm-4">
                            <div className="content-container">
                                <h3 className={'footer-head ' + (this.state.collapsible.showAboutUsAddBtn ? 'add-icon' : 'sub-icon')}
                                    onClick={(e) => this.slideDiv(e, 'abtCollapse', 'showAboutUsAddBtn')}>About Us</h3>
                                <div id="abtCollapse" className="footer-inner">
                                    <p><Link to={routesPath['COMPANY_OVERVIEW']} title="Company Overview">Company
                                        Overview</Link></p>
                                    <p><Link to={routesPath['PRIVACY_POLICY']} title="Privacy Policy">Privacy
                                        Policy</Link></p>
                                    <p><Link to={routesPath['TERMS_OF_SERVICE']} title="Terms of Service">Terms of
                                        Service</Link></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-4">
                            <div className="content-container">
                                <h3 className={'footer-head ' + (this.state.collapsible.showUsefullLinkAddBtn ? 'add-icon' : 'sub-icon')}
                                    onClick={(e) => this.slideDiv(e, 'usefullCollapse', 'showUsefullLinkAddBtn')}>Useful
                                    Links</h3>
                                <div id="usefullCollapse" className="footer-inner">
                                    <p><Link to={routesPath['FAQ']} title="FAQs">FAQs</Link></p>
                                    <p><Link to={routesPath['SUPPORT_CENTER']} title="Support and Suggestions">Support
                                        and Suggestions</Link></p>
                                </div>
                            </div>
                        </div>
                        <div className="col-sm-4">
