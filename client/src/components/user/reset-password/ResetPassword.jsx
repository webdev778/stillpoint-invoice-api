...
export default class ResetPassword extends React.Component {
    ...
    _handleClick(e) {
        ...
        if (this.state.formValid && (this.state.password == this.state.confirm_password)) {
            ...
            utils.apiCall('RESET_PASSWORD', {
                'params': [this.props.params.secretId],
                'data': data
                ...
                {this.state.validLink ? (this.state.showSuccess ? (<div className="reset-link-page-wrapper">
                    <section className="right-section reset-link-section pull-right">
                        ...
                        <div className="form-wrapper">
                            ...
                            <div className="btns">
                                <button type="submit" className="btn reset-link-btn"
                                        onClick={() => utils.changeUrl(routesPath['SIGN_IN'])}>Sign In
                                </button>
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="right-section forgot-pwd-section pull-right">
                        <div className="white-logo-bg"><img onClick={() => Util.goToHome()}
                                                            src={constant['IMG_PATH'] + 'primaryHorizontalRgb@2x.jpg'}
                                                            alt="leably-white-logo"
                                                            className="img-responsive mobile-on-logo" width="120"
                                                            height="31"/></div>
                        <div className="form-wrapper">
                            <h4>Reset Password</h4>
                            <p className="mb-30">It’s a good idea to use a strong password that you don’t use
                                elsewhere.</p>
                            <form className="forgot-pwd-form" onSubmit={this._handleClick}>
                                <div
                                    ...
                                    <div className="pwd-wrapper">
                                        <input type="password" className="pswd form-control" id="new-pwd"
                                               placeholder="New Password" name="password" value={this.state.password}
                                               onBlur={this.handleInputOnBlur} onChange={this.handleUserInput}/>
                                        <span
                                            onClick={() => this.showPassword("new-pwd", "showPass", this.state.showPass)}
                                            className="eye"><i
                                ...
                                <div
                                    ...
                                    <div className="pwd-wrapper">
                                        <input type="password" className="pswd form-control" id="re-pwd"
                                               placeholder="Retype New Password" name="confirm_password"
                                               value={this.state.confirm_password} onBlur={this.handleInputOnBlur}
                                               onChange={this.handleUserInput}/>
                                        <span className="eye"><i className="fa fa-eye"></i></span>
                                        <span
                                            onClick={() => this.showPassword("re-pwd", "showRePass", this.state.showRePass)}
                                            className="eye"><i
                    ...
                    <section className="right-section reset-link-section pull-right">
                        <div className="white-logo-bg"><img onClick={() => utils.goToHome()}
                                                            src={constant['IMG_PATH'] + 'primaryHorizontalRgb@2x.jpg'}
                                                            alt="leably-white-logo"
                                                            className="img-responsive mobile-on-logo" width="120"
                                                            height="31"/></div>
                        <div className="form-wrapper">
                            <img src={constant['IMG_PATH'] + 'reset-link.png'} alt="reset-link"
                                 className="img-responsive"/>
                            <h5>Invalid Link or Link has been expired</h5>
                            <div className="btns">
                                <button onClick={() => utils.changeUrl(routesPath['SIGN_IN'])}
                                        className="btn reset-link-btn">Continue to Sign In
                                </button>
                            </div>
                        </div>
                    </section>
