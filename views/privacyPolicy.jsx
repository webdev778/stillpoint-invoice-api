  ...
  componentDidMount() {
    ...
    return (
        ...
        <div className="static-panel-div">
          This privacy policy sets out how Legably uses and protects any information that you give “[business name]” when you use this website.<br/><br/>
          ...
          Legably users may review any personal information maintained by Legably by contacting us at <a className="contact-link" href='mailto:support@legably.com'>support@legably.com</a>.<br/><br/>
          If you believe that any information we are holding on you is incorrect or incomplete, please contact us at <a className="contact-link" href='mailto:support@legably.com'>support@legably.com</a>. We will promptly correct any information found to be incorrect.<br/><br/>
          <h1>Contact Information</h1>
          Please feel free to contact us via email at <a className="contact-link" href='mailto:support@legably.com'>support@legably.com</a> for any information on Legably’s privacy policy and initiatives.
        </div>
